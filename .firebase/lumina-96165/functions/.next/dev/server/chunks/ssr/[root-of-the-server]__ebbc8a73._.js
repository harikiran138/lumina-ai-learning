...
"[project]/src/app/actions/data:8966d2 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$8966d2__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/actions/data:8966d2 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$30edd9__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/actions/data:30edd9 [app-ssr] (ecmascript) <text/javascript>");
;
class RealAPI {
    static instance;
    currentUser = null;
    ...
    async login(email, password) {
        ...
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$8966d2__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["authenticateUser"])(email, password);
        if (user) {
    ...
    async createUser(userData) {
        ...
        // Call server action
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$30edd9__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["registerUser"])(userData);
        if ('error' in result) {
    ...
    async getDashboardData(userRole, userId) {
        ...
        if (userRole === 'student') {
            ...
            const { getStudentDashboard } = await __turbopack_context__.A("[project]/src/app/actions/data.ts [app-ssr] (ecmascript, async loader)");
            const data = await getStudentDashboard(user.email);
            return data || {};
        }
        if (userRole === 'teacher') {
            const { getTeacherDashboard } = await __turbopack_context__.A("[project]/src/app/actions/data.ts [app-ssr] (ecmascript, async loader)");
            return await getTeacherDashboard(user.email);
        }
        if (userRole === 'admin') {
            const { getAdminDashboard } = await __turbopack_context__.A("[project]/src/app/actions/data.ts [app-ssr] (ecmascript, async loader)");
    ...
    async getStudentProfile() {
        const user = await this.getCurrentUser();
        if (!user) return null;
        const { getStudentProfile } = await __turbopack_context__.A("[project]/src/app/actions/data.ts [app-ssr] (ecmascript, async loader)");
    ...
    async updateProfile(data) {
        ...
        const { updateStudentProfile } = await __turbopack_context__.A("[project]/src/app/actions/data.ts [app-ssr] (ecmascript, async loader)");
        return await updateStudentProfile(user.email, data);
    }
    async getCourseDetails(courseId) {
        const { getCourseDetails } = await __turbopack_context__.A("[project]/src/app/actions/data.ts [app-ssr] (ecmascript, async loader)");
        return await getCourseDetails(courseId);
    }
    async getEnrolledCourses() {
        const user = await this.getCurrentUser();
        if (!user) return null;
        const { getStudentProgress } = await __turbopack_context__.A("[project]/src/app/actions/data.ts [app-ssr] (ecmascript, async loader)");
        return await getStudentProgress(user.email);
    }
    async getCommunityData(channelId) {
        const { getCommunityData } = await __turbopack_context__.A("[project]/src/app/actions/data.ts [app-ssr] (ecmascript, async loader)");
        return await getCommunityData(channelId);
    }
    async getTeacherStudents() {
        const user = await this.getCurrentUser();
        if (!user) return [];
        const { getTeacherStudents } = await __turbopack_context__.A("[project]/src/app/actions/data.ts [app-ssr] (ecmascript, async loader)");
        return await getTeacherStudents(user.email);
    }
    async getTeacherCourses() {
        const user = await this.getCurrentUser();
        if (!user) return [];
        const { getTeacherCourses } = await __turbopack_context__.A("[project]/src/app/actions/data.ts [app-ssr] (ecmascript, async loader)");
    ...
    async createCourse(courseData) {
        ...
        const { createCourse } = await __turbopack_context__.A("[project]/src/app/actions/data.ts [app-ssr] (ecmascript, async loader)");
...
"[project]/src/components/dashboard/TeacherSidebar.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            fileName: "[project]/src/components/dashboard/TeacherSidebar.tsx",
                            lineNumber: 32,
                            columnNumber: 21
                        }, this),
                        " ✨"
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                ...
                children: navItems.map((item)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-300", isActive ? "bg-lumina-primary/20 text-lumina-primary shadow-[0_0_15px_rgba(255,215,0,0.1)] border border-lumina-primary/10" : "text-gray-400 hover:bg-white/5 hover:text-gray-200 hover:translate-x-1"),
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(item.icon, {
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("mr-3 h-5 w-5", isActive ? "text-lumina-primary" : "text-gray-500 group-hover:text-gray-300")
                            }, void 0, false, {
                                fileName: "[project]/src/components/dashboard/TeacherSidebar.tsx",
                                lineNumber: 50,
                                columnNumber: 29
...
"[project]/src/components/dashboard/TopNav.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/teacher/layout.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$TeacherSidebar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/dashboard/TeacherSidebar.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$TopNav$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/dashboard/TopNav.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
'use client';
;
;
...
function TeacherLayout({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$TeacherSidebar$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/src/app/teacher/layout.tsx",
                lineNumber: 17,
                columnNumber: 13
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$TopNav$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ebbc8a73._.js.map