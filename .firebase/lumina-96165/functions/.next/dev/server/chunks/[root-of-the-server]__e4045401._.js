...
if ("TURBOPACK compile-time truthy", 1) {
    ...
    if (!globalWithMongo._mongoClientPromise) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vercel$2f$functions$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["attachDatabasePool"])(client);
...
async function GET() {
    try {
        ...
        const db = client.db('lumina-database'); // Use the DB name from the URI if possible, or default
        // Just a simple ping
        await db.command({
            ping: 1
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e4045401._.js.map
