...
const FULL_COURSES = [
  {
    ...
    expandedDescription:
      "This comprehensive course takes you beyond the basics of React. You will learn how to build reusable, flexible, and performant components using advanced patterns like Compound Components, Control Props, and Custom Hooks. Perfect for developers looking to level up their React skills.",
    thumbnail:
...
\`\`\`
          ...
          },
          {
            ...
            questions: [
              ...
              },
              {
                id: "q2",
                question:
                  "Which React API is commonly used to share state in Compound Components?",
                options: ["useState", "useEffect", "Context API", "useReducer"],
                correctAnswer: 2,
              },
            ],
          },
            ...
            questions: [
              {
                id: "q1",
                question:
                  "Rules of Hooks dictate that hooks must be called from...",
                options: [
  ...
  },
  {
    ...
    expandedDescription:
      "From Pandas to NumPy, this course covers the essential libraries for data analysis in Python. You'll work with real datasets (Titanic, Housing Prices) and learn how to visualize data effectively using Matplotlib and Seaborn.",
    thumbnail:
      "https://images.unsplash.com/photo-1526379095098-d400fd0bf935?q=80&w=3274&auto=format&fit=crop",
    level: "Intermediate",
    status: "Active",
    modules: [
      {
  ...
  },
  {
    ...
    expandedDescription:
      "Understand the fundamentals of Supervised and Unsupervised learning. We cover Linear Regression, Logistic Regression, and K-Means Clustering with hands-on examples.",
    thumbnail:
