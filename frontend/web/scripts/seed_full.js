...
userDocs.push({
  ...
  status: "active",
  avatar:
    "https://ui-avatars.com/api/?name=Admin+User&background=C0392B&color=fff",
...
userDocs.push({
  ...
  status: "active",
  avatar:
    "https://ui-avatars.com/api/?name=Student+User&background=0D8ABC&color=fff",
  createdAt: new Date().toISOString(),
});
...
const courseTemplates = [
  {
    ...
    desc: "Introduction to Wave Functions.",
  },
  {
    id: "bio_101",
    name: "Advanced Biology",
    desc: "Cellular processes and genetics.",
  },
  {
    id: "ai_202",
  ...
  for (let i = 0; i < numCourses; i++) {
    ...
    progressDocs.push({
      ...
      lastAccessed: new Date(
        Date.now() - randomInt(0, 604800000),
      ).toISOString(),
    });
  }
});
