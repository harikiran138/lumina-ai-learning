...
\`\`\`
    ...
    if (compoundQuiz) {
      compoundQuiz.questions[0].question =
        "What is the main benefit of Compound Components?";
      compoundQuiz.questions[0].options = [
        "Flexible Layout",
        "Faster Rendering",
        "Less Code",
        "Global State",
      ...
      compoundQuiz.questions[1].question =
        "Which API is key for Compound Components?";
      compoundQuiz.questions[1].options = [
        "useState",
        "useEffect",
        "Context API",
        "Redux",
    ...
    const courses = [
      {
        ...
        description:
          "Master modern React with advanced patterns and performance tuning.",
        expandedDescription:
          "10 Modules containing Video, Text, Slides, and comprehensive Quizzes.",
        thumbnail:
