...
const COURSES_DATABASE = {
  ...
  math_calculus_1: {
    ...
    description:
      "Master the fundamentals of calculus including limits, continuity, derivatives, and their applications.",
    instructor: {
      id: "teacher_001",
    ...
    price: 49.99,
    image:
      "https://images.unsplash.com/photo-1577720643272-265b434e3884?w=400&h=250&fit=crop",
    thumbnail:
      "https://images.unsplash.com/photo-1577720643272-265b434e3884?w=150&h=150&fit=crop",
  ...
  math_linear_algebra: {
    ...
    description:
      "Learn matrices, vectors, eigenvalues, and linear transformations with practical applications.",
    instructor: {
      id: "teacher_002",
      name: "Dr. James Chen",
    ...
    price: 59.99,
    image:
      "https://images.unsplash.com/photo-1594716992062-786257b39c6d?w=400&h=250&fit=crop",
    thumbnail:
      "https://images.unsplash.com/photo-1594716992062-786257b39c6d?w=150&h=150&fit=crop",
  ...
  cs_python_fundamentals: {
    ...
    description:
      "Learn Python from scratch with real-world projects and best practices.",
    instructor: {
      id: "teacher_003",
      name: "Alex Rodriguez",
  ...
  cs_web_development: {
    ...
    description:
      "Build modern, responsive web applications with HTML, CSS, JavaScript, and frameworks.",
    instructor: {
      id: "teacher_004",
      name: "Emma Thompson",
    ...
    thumbnail:
      "https://images.unsplash.com/photo-1633356122544-f134324ef6db?w=150&h=150&fit=crop",
  ...
  physics_mechanics: {
    ...
    description:
      "Study motion, forces, energy, and momentum in classical physics.",
    instructor: {
      id: "teacher_001",
  ...
  physics_electricity: {
    ...
    description:
      "Explore electric fields, magnetic fields, circuits, and electromagnetic waves.",
    instructor: {
      id: "teacher_006",
    ...
    price: 59.99,
    image:
      "https://images.unsplash.com/photo-1516714435840-f2adc3f3fee1?w=400&h=250&fit=crop",
    thumbnail:
      "https://images.unsplash.com/photo-1516714435840-f2adc3f3fee1?w=150&h=150&fit=crop",
  ...
  chemistry_general: {
    ...
    description:
      "Introduction to chemistry: atomic structure, bonding, reactions, and stoichiometry.",
    instructor: {
      id: "teacher_007",
    ...
    price: 49.99,
    image:
      "https://images.unsplash.com/photo-1629904531159-d36694d7f2c4?w=400&h=250&fit=crop",
    thumbnail:
      "https://images.unsplash.com/photo-1629904531159-d36694d7f2c4?w=150&h=150&fit=crop",
  ...
  biology_molecular: {
    ...
    description:
      "Study DNA, RNA, proteins, and cellular processes at the molecular level.",
    instructor: {
      id: "teacher_008",
      name: "Prof. Lisa Wong",
    ...
    price: 69.99,
    image:
      "https://images.unsplash.com/photo-1576091160550-112173f7f869?w=400&h=250&fit=crop",
    thumbnail:
      "https://images.unsplash.com/photo-1576091160550-112173f7f869?w=150&h=150&fit=crop",
  ...
  language_spanish_101: {
    ...
    subcategory: "Spanish",
    description:
      "Learn Spanish basics: vocabulary, grammar, pronunciation, and conversation skills.",
    instructor: {
      id: "teacher_009",
      name: "Maria Gonzalez",
    ...
    price: 39.99,
    image:
      "https://images.unsplash.com/photo-1623813551600-f5da88e6f2f2?w=400&h=250&fit=crop",
    thumbnail:
      "https://images.unsplash.com/photo-1623813551600-f5da88e6f2f2?w=150&h=150&fit=crop",
  ...
  language_french_101: {
    ...
    subcategory: "French",
    description:
      "Master French fundamentals with interactive lessons and authentic materials.",
    instructor: {
      id: "teacher_010",
      name: "Pierre Dubois",
    ...
    price: 39.99,
    image:
      "https://images.unsplash.com/photo-1512941691920-25bde2e4dc75?w=400&h=250&fit=crop",
    thumbnail:
      "https://images.unsplash.com/photo-1512941691920-25bde2e4dc75?w=150&h=150&fit=crop",
  ...
  business_marketing_101: {
    ...
    description:
      "Learn modern digital marketing strategies, social media, and analytics.",
    instructor: {
      id: "teacher_011",
      name: "Chris Anderson",
    ...
    thumbnail:
      "https://images.unsplash.com/photo-1460925895917-adf4e565db18?w=150&h=150&fit=crop",
  ...
  design_ux_ui: {
    ...
    description:
      "Learn user experience and interface design with real-world projects.",
    instructor: {
      id: "teacher_012",
      name: "Jessica Lee",
...
function getCoursesByCategory(category) {
  return Object.values(COURSES_DATABASE).filter(
