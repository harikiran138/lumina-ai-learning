(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (t) => {
    ...
    let o = (t, e, i) => Math.max(Math.min(t, i), e);
    function l(t) {
      return o(n(2.55 * t), 0, 255);
    }
    function h(t) {
      return o(n(255 * t), 0, 255);
    }
    function d(t) {
      return o(n(t / 2.55) / 100, 0, 1);
    }
    function c(t) {
      return o(n(100 * t), 0, 100);
    }
    let u = {
        0: 0,
        1: 1,
    ...
    class T {
                ...
                return "r" === t.charAt(0)
                  ? (function (t) {
                      ...
                      if (a) {
                        if (a[7] !== e) {
                          let t = +a[7];
                          r = a[8] ? l(t) : o(255 * t, 0, 255);
                        }
                        return (
                          (e = +a[1]),
                          (i = +a[3]),
                          (s = +a[5]),
                          (e = 255 & (a[2] ? l(e) : o(e, 0, 255))),
                          {
                            r: e,
                            g: (i = 255 & (a[4] ? l(i) : o(i, 0, 255))),
                            b: (s = 255 & (a[6] ? l(s) : o(s, 0, 255))),
                            a: r,
                          }
                        );
                      }
      ...
      hexString() {
        ...
        return this._valid
          ? ((e =
              m((i = t = this._rgb).r) && m(i.g) && m(i.b) && m(i.a) ? f : p),
            t
              ? "#" +
                e(t.r) +
                e(t.g) +
    ...
    function U(t) {
      if (z(t)) return t.map(U);
      if (F(t)) {
        let e = Object.create(null),
          i = Object.keys(t),
          s = i.length,
          a = 0;
        for (; a < s; ++a) e[i[a]] = U(t[i[a]]);
        return e;
      }
      return t;
    }
    ...
    function J(t, e, i) {
      ...
      F(s) && F(a)
        ? K(s, a)
        : Object.prototype.hasOwnProperty.call(e, t) || (e[t] = U(a));
    }
    ...
    function tf(t) {
      let e = Math.round(t),
        i = Math.pow(10, Math.floor(tc((t = tg(t, e, t / 1e3) ? e : t)))),
        s = t / i;
    ...
    function t_(t, e) {
      let i = e.x - t.x,
        ...
        a = Math.sqrt(i * i + s * s),
        r = Math.atan2(s, i);
      return r < -0.5 * ts && (r += ta), { angle: r, distance: a };
    }
    function ty(t, e) {
    ...
    let tD = (t, e, i, s) =>
      ...
      tC = (t, e, i) => tP(t, i, (s) => t[s][e] >= i),
      tO = ["push", "pop", "shift", "splice", "unshift"];
    function tA(t, e) {
      let i = t._chartjs;
      if (!i) return;
      let s = i.listeners,
    ...
    let tR = (t) => ("start" === t ? "left" : "end" === t ? "right" : "center"),
      tj = (t, e, i) => ("start" === t ? e : "end" === t ? i : (e + i) / 2);
    function tz(t, e, i) {
      let s = e.length,
        a = 0,
        r = s;
      if (t._sorted) {
        let { iScale: n, vScale: o, _parsed: l } = t,
          ...
          d = n.axis,
          { min: c, max: u, minDefined: g, maxDefined: f } = n.getUserBounds();
        if (g) {
          if (
            ((a = Math.min(
              tD(l, d, c).lo,
              i ? s : tD(e, d, n.getPixelForValue(c)).lo,
            )),
            h)
          ) {
            let t = l
        ...
        if (f) {
          let t = Math.max(
            tD(l, n.axis, u, !0).hi + 1,
            i ? 0 : tD(e, d, n.getPixelForValue(u), !0).hi + 1,
          );
          if (h) {
            let e = l.slice(t - 1).findIndex((t) => !j(t[o.axis]));
            t += Math.max(0, e);
          }
          r = tk(t, a, s) - a;
        } else r = s - a;
    ...
    let tN = (t) => 0 === t || 1 === t,
      tI = (t, e, i) =>
        -(Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * ta) / i)),
      tV = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * ta) / i) + 1,
      tB = {
        linear: (t) => t,
        easeInQuad: (t) => t * t,
        easeOutQuad: (t) => -t * (t - 2),
        ...
        easeInOutQuint: (t) =>
          (t /= 0.5) < 1
            ? 0.5 * t * t * t * t * t
            : 0.5 * ((t -= 2) * t * t * t * t + 2),
        easeInSine: (t) => -Math.cos(t * tl) + 1,
        easeOutSine: (t) => Math.sin(t * tl),
        easeInOutSine: (t) => -0.5 * (Math.cos(ts * t) - 1),
        ...
        easeInElastic: (t) => (tN(t) ? t : tI(t, 0.075, 0.3)),
        easeOutElastic: (t) => (tN(t) ? t : tV(t, 0.075, 0.3)),
        easeInOutElastic: (t) =>
          tN(t)
            ? t
            : t < 0.5
              ? 0.5 * tI(2 * t, 0.1125, 0.45)
              : 0.5 + 0.5 * tV(2 * t - 1, 0.1125, 0.45),
        ...
        easeInBounce: (t) => 1 - tB.easeOutBounce(1 - t),
        easeOutBounce: (t) =>
        ...
        easeInOutBounce: (t) =>
          t < 0.5
            ? 0.5 * tB.easeInBounce(2 * t)
            : 0.5 * tB.easeOutBounce(2 * t - 1) + 0.5,
      };
    function tW(t) {
    ...
    function tH(t) {
      return tW(t) ? t : new T(t);
    }
    function t$(t) {
      return tW(t) ? t : new T(t).saturate(0.5).darken(0.1).hexString();
    }
    let tU = ["x", "y", "borderWidth", "radius", "tension"],
      tY = ["color", "borderColor", "backgroundColor"],
      tX = new Map();
    function tq(t, e, i) {
      var s;
      let a, r;
      return ((a = e + JSON.stringify((s = (s = i) || {}))),
      !(r = tX.get(a)) && ((r = new Intl.NumberFormat(e, s)), tX.set(a, r)),
      r).format(t);
    }
    let tK = {
        values: (t) => (z(t) ? t : "" + t),
        numeric(t, e, i) {
          ...
          return Object.assign(d, this.options.ticks.format), tq(t, a, d);
        },
        logarithmic(t, e, i) {
          return 0 === t
            ? "0"
            : [1, 2, 3, 5, 10, 15].includes(
                  i[e].significand || t / Math.pow(10, Math.floor(tc(t))),
                ) || e > 0.8 * i.length
              ? tK.numeric.call(this, t, e, i)
              : "";
        },
      },
    ...
    function tG(t, e, i) {
      return "string" == typeof e ? q(tQ(t, e), i) : q(tQ(t, ""), e);
    }
    var t0 = new (class {
      constructor(t, e) {
        ...
        Object.defineProperties(a, {
          ...
          [e]: {
            ...
            get() {
              let t = this[n],
                e = r[s];
              return F(t) ? Object.assign({}, e, t) : V(t, e);
            },
            set(t) {
              this[n] = t;
            },
      ...
      [
        function (t) {
          t.set("animation", {
            ...
            t.set("animations", {
              colors: { type: "color", properties: tY },
    ...
    function t6(t, e, i, s, a) {
      ...
      if (
        g &&
        "object" == typeof g &&
        ("[object HTMLImageElement]" === (r = g.toString()) ||
      ...
      if (!isNaN(p) && !(p <= 0)) {
        switch ((t.beginPath(), g)) {
          default:
            a ? t.ellipse(i, s, a / 2, p, 0, 0, ta) : t.arc(i, s, p, 0, ta),
              t.closePath();
            break;
          case "triangle":
            (d = a ? a / 2 : p),
          ...
          case "rectRounded":
            (h = 0.516 * p),
              (n = Math.cos(m + th) * (l = p - h)),
              (c = Math.cos(m + th) * (a ? a / 2 - h : l)),
              (o = Math.sin(m + th) * l),
              (u = Math.sin(m + th) * (a ? a / 2 - h : l)),
              t.arc(i - c, s - o, h, m - ts, m - tl),
              t.arc(i + u, s - n, h, m - tl, m),
              t.arc(i + c, s + o, h, m, m + tl),
              t.arc(i - u, s + n, h, m + tl, m + ts),
              t.closePath();
            break;
          case "rect":
            if (!f) {
    ...
    function ee(t, e, i, s, a, r = {}) {
      ...
      for (
        t.save(),
          ...
          j(r.rotation) || t.rotate(r.rotation),
        ...
        (o = l[n]),
          ...
          h &&
            ...
            j(r.strokeWidth) || (t.lineWidth = r.strokeWidth),
    ...
    function ei(t, e) {
      ...
      t.arc(i + n.topLeft, s + n.topLeft, n.topLeft, 1.5 * ts, ts, !0),
        t.lineTo(i, s + r - n.bottomLeft),
        t.arc(i + n.bottomLeft, s + r - n.bottomLeft, n.bottomLeft, ts, tl, !0),
        ...
        t.arc(i + a - n.topRight, s + n.topRight, n.topRight, 0, -tl, !0),
        t.lineTo(i + n.topLeft, s);
    }
    let es = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
      ea =
    ...
    function en(t, e) {
      let i = {},
        s = F(e),
        a = s ? Object.keys(e) : e,
        r = F(t) ? (s ? (i) => V(t[i], t[e[i]]) : (e) => t[e]) : () => t;
      for (let t of a) i[t] = er(r(t));
      return i;
    }
    function eo(t) {
      return en(t, { top: "y", right: "x", bottom: "y", left: "x" });
    }
    function el(t) {
      return en(t, ["topLeft", "topRight", "bottomLeft", "bottomRight"]);
    }
    function eh(t) {
      let e = eo(t);
    ...
    function ec(t, e, i, s) {
      ...
      for (a = 0, r = t.length; a < r; ++a)
        if (
          ...
          void 0 !== i && z(n) && ((n = n[i % n.length]), (o = !1)),
          void 0 !== n)
        )
    ...
    function eg(t, e = [""], i, s, a = () => t[0]) {
      let r = i || t;
      return (
        void 0 === s && (s = ew("_fallback", t)),
        new Proxy(
          {
            ...
            get: (i, s) =>
              eb(i, s, () =>
                (function (t, e, i, s) {
                  let a;
                  for (let r of e)
                    if (void 0 !== (a = ew(em(r, t), i)))
                      return ex(t, a) ? ey(i, s, t, a) : a;
                })(s, e, t, i),
              ),
            getOwnPropertyDescriptor: (t, e) =>
              Reflect.getOwnPropertyDescriptor(t._scopes[0], e),
            getPrototypeOf: () => Reflect.getPrototypeOf(t[0]),
            has: (t, e) => eM(t).includes(e),
            ownKeys: (t) => eM(t),
            set(t, e, i) {
      ...
      return new Proxy(
        {
          ...
          _stack: new Set(),
          _descriptors: ep(t, s),
          setContext: (e) => ef(t, e, i, s),
          override: (a) => ef(t.override(a), e, i, s),
        },
        {
                ...
                return (
                  te(o) &&
                    ...
                    (o = (function (t, e, i, s) {
                      ...
                      let l = e(r, n || s);
                      return (
                        o.delete(t), ex(t, l) && (l = ey(a._scopes, a, t, l)), l
                      );
                    })(e, o, t, i)),
                  z(o) &&
                    o.length &&
                    (o = (function (t, e, i, s) {
                      ...
                      if (F(e[0])) {
                        ...
                        for (let l of ((e = []), i)) {
                          let i = ey(s, a, t, l);
                          e.push(ef(i, r, n && n[t], o));
                        }
                      }
                      return e;
                    })(e, o, t, n.isIndexable)),
                  ex(e, o) && (o = ef(o, a, r && r[e], n)),
                  o
                );
              })(t, e, i),
            ),
    ...
    function ep(t, e = { scriptable: !0, indexable: !0 }) {
      let {
      ...
      return {
        ...
        scriptable: i,
        indexable: s,
        isScriptable: te(i) ? i : () => i,
        isIndexable: te(s) ? s : () => s,
      };
    }
    let em = (t, e) => (t ? t + G(e) : e),
      ex = (t, e) =>
        F(e) &&
        "adapters" !== t &&
    ...
    let e_ = (t, e) => (!0 === t ? e : "string" == typeof t ? Q(e, t) : void 0);
    function ey(t, e, i, s) {
      var a;
      let r = e._rootScopes,
        n = ((a = e._fallback), te(a) ? a(i, s) : a),
        o = [...t, ...r],
        l = new Set();
      l.add(s);
      let h = ev(l, o, i, n || i, s);
      return (
        null !== h &&
        (void 0 === n || n === i || null !== (h = ev(l, o, n, h, s))) &&
        eg(Array.from(l), [""], r, n, () => {
          var t, a, r;
          let n, o;
          return (
            ...
            (a = i),
            (r = s),
            a in (n = t._getTarget()) || (n[a] = {}),
            z((o = n[a])) && F(r) ? r : o || {}
          );
        })
      );
    }
    function ev(t, e, i, s, a) {
      for (; i; )
        i = (function (t, e, i, s, a) {
          for (let n of e) {
            ...
            if (e) {
              var r;
              t.add(e);
              let n = ((r = e._fallback), te(r) ? r(i, a) : r);
    ...
    function ek(t, e, i, s) {
      let a,
        ...
        h = Array(s);
      for (a = 0; a < s; ++a)
        (n = e[(r = a + i)]), (h[a] = { r: o.parse(Q(n, l), r) });
      return h;
    }
    let eS = Number.EPSILON || 1e-14,
    ...
    let eT = (t) => t.ownerDocument.defaultView.getComputedStyle(t, null),
      ...
      let { canvas: i, currentDevicePixelRatio: s } = e,
        ...
        o = eR(a, "border", "width"),
        {
          ...
          let i,
            ...
            r = t.touches,
            n = r && r.length ? r[0] : t,
            { offsetX: o, offsetY: l } = n,
            h = !1;
          if (((a = t.target), (o > 0 || l > 0) && (!a || !a.shadowRoot)))
            (i = o), (s = l);
          else {
            let t = e.getBoundingClientRect();
            (i = n.clientX - t.left), (s = n.clientY - t.top), (h = !0);
          }
        ...
        { width: g, height: f } = e;
      return (
        r && ((g -= n.width + o.width), (f -= n.height + o.height)),
        {
          x: Math.round((((l - c) / g) * i.width) / s),
          y: Math.round((((h - u) / f) * i.height) / s),
        }
      );
    }
    let ez = (t) => Math.round(10 * t) / 10;
    function eF(t, e, i) {
      let s = e || 1,
        a = ez(t.height * s),
        r = ez(t.width * s);
      (t.height = ez(t.height)), (t.width = ez(t.width));
      let n = t.canvas;
      return (
        n.style &&
        ...
        (t.currentDevicePixelRatio !== s || n.height !== a || n.width !== r) &&
    ...
    function eY(t) {
      return "angle" === t
        ? { between: tM, compare: tv, normalize: tw }
        : { between: tS, compare: (t, e) => t - e, normalize: (t) => t };
    }
    function eX({ start: t, end: e, count: i, loop: s, style: a }) {
      return {
        start: t % i,
        end: e % i,
        loop: s && (e - t + 1) % i == 0,
    ...
    function eq(t, e, i) {
      ...
      let { property: n, start: o, end: l } = i,
        h = e.length,
        { compare: d, between: c, normalize: u } = eY(n),
        {
          start: g,
          end: f,
          loop: p,
          ...
          let s,
            { property: a, start: r, end: n } = i,
            { between: o, normalize: l } = eY(a),
            h = e.length,
            { start: d, end: c, loop: u } = t;
          if (u) {
            for (d += h, c += h, s = 0; s < h && o(l(e[d % h][a]), r, n); ++s)
              d--, c--;
            (d %= h), (c %= h);
          }
          return (
      ...
      for (let t = g, i = g; t <= f; ++t)
        (a = e[t % h]).skip ||
          ((s = u(a[n])) !== r &&
            ...
            null !== _ &&
              v() &&
              (x.push(eX({ start: _, end: t, loop: p, count: h, style: m })),
              (_ = null)),
            (i = t),
            (r = s)));
      return (
        null !== _ &&
          x.push(eX({ start: _, end: f, loop: p, count: h, style: m })),
        x
      );
    }
    function eK(t, e) {
    ...
    class e5 {
      constructor(t, e, i, s) {
        const a = e[i];
        s = ec([t.to, s, a, t.from]);
        const r = ec([t.from, a, s]);
        (this._active = !0),
          (this._fn = t.fn || e2[t.type || typeof r]),
          (this._easing = tB[t.easing] || tB.linear),
      ...
      update(t, e, i) {
        if (this._active) {
          ...
          (this._start = i),
            ...
            (this._total += a),
            (this._loop = !!t.loop),
            (this._to = ec([t.to, e, s, t.from])),
            (this._from = ec([t.from, s, e]));
        }
      }
      cancel() {
        this._active &&
    ...
    class e4 {
      ...
      configure(t) {
        if (!F(t)) return;
        let e = Object.keys(t0.animation),
          i = this._properties;
        Object.getOwnPropertyNames(t).forEach((s) => {
          ...
          ((z(a.properties) && a.properties) || [s]).forEach((t) => {
      ...
      update(t, e) {
        ...
        if (i.length) return e0.add(this._chart, i), !0;
      }
    }
    function e6(t, e) {
      let i = (t && t.options) || {},
    ...
    function e8(t, e, i, s = {}) {
      ...
      for (a = 0, r = l.length; a < r; ++a) {
        ...
        N((o = t.values[n])) && (h || 0 === e || tu(e) === tu(o)) && (e += o);
      }
      return d || s.all ? e : 0;
    }
    function e7(t, e) {
    ...
    function it(t, e) {
      ...
      for (let t = 0; t < u; ++t) {
        ...
        ((i = (s._stacks || (s._stacks = {}))[d] =
          ...
          (i._top = e9(i, o, !0, a.type)),
          (i._bottom = e9(i, o, !1, a.type)),
    ...
    let is = (t) => "reset" === t || "none" === t,
      ia = (t, e) => (e ? t : Object.assign({}, t));
    class ir {
      static defaults = {};
      ...
      linkScales() {
        let t = this.chart,
          ...
          a = (e.xAxisID = V(i.xAxisID, ie(t, "x"))),
          r = (e.yAxisID = V(i.yAxisID, ie(t, "y"))),
          n = (e.rAxisID = V(i.rAxisID, ie(t, "r"))),
          o = e.indexAxis,
      ...
      _destroy() {
        let t = this._cachedMeta;
        this._data && tA(this._data, this), t._stacked && ii(t);
      }
      _dataCheck() {
      ...
      buildOrUpdateElements(t) {
        ...
        this._dataCheck();
        let a = e._stacked;
        (e._stacked = e7(e.vScale, e)),
          e.stack !== i.stack && ((s = !0), ii(e), (e.stack = i.stack)),
          this._resyncElements(t),
          (s || a !== e._stacked) &&
            (it(this, e._parsed), (e._stacked = e7(e.vScale, e)));
      }
      configure() {
      ...
      parse(t, e) {
        let i,
          s,
          a,
          { _cachedMeta: r, _data: n } = this,
          { iScale: o, _stacked: l } = r,
          h = o.axis,
          d = (0 === t && e === n.length) || r._sorted,
          c = t > 0 && r._parsed[t - 1];
        if (!1 === this._parsing) (r._parsed = n), (r._sorted = !0), (a = n);
        else {
          a = z(n[t])
          ...
          for (i = 0; i < e; ++i)
            (r._parsed[i + t] = s = a[i]), d && (o() && (d = !1), (c = s));
          r._sorted = d;
        }
        l && it(this, a);
      }
      ...
      parseObjectData(t, e, i, s) {
        ...
        for (a = 0; a < s; ++a)
          (n = e[(r = a + i)]),
            (c[a] = { x: o.parse(Q(n, h), r), y: l.parse(Q(n, d), r) });
        return c;
      }
      getParsed(t) {
      ...
      applyStack(t, e, i) {
        let s = this.chart,
          ...
          r = e[t.axis];
        return e8(
          { keys: e3(s, !0), values: e._stacks[t.axis]._visualValues },
          r,
          a.index,
          { mode: i },
        );
      ...
      updateRangeFromParsed(t, e, i, s) {
        ...
        s && n && ((s.values = n), (r = e8(s, a, this._cachedMeta.index))),
      ...
      getMinMax(t, e) {
        let i,
          ...
          d =
            ((a = this.chart),
            e && !r.hidden && r._stacked && { keys: e3(a, !0), values: null }),
          c = { min: 1 / 0, max: -1 / 0 },
        ...
        function f() {
          let e = (s = n[i])[h.axis];
          return !N(s[t.axis]) || u > e || g < e;
        }
        for (
          i = 0;
          i < l && (f() || (this.updateRangeFromParsed(c, t, s, d), !o));
          ++i
        );
        if (o) {
          for (i = l - 1; i >= 0; --i)
      ...
      getContext(t, e, i) {
        ...
        if (t >= 0 && t < this._cachedMeta.data.length) {
          ...
          ((r =
            this.$context ||
            (this.$context = eu(this.chart.getContext(), {
              active: !1,
              dataset: void 0,
      ...
      _resolveElementOptions(t, e = "default", i) {
        let s = "active" === e,
          ...
          r = t + "-" + e,
          n = a[r],
          o = this.enableOptionSharing && tt(i);
        if (n) return ia(n, o);
        let l = this.chart.config,
          h = l.datasetElementScopeKeys(this._type, t),
          d = s ? [`${t}Hover`, "hover", t, ""] : [t, ""],
          c = l.getOptionScopes(this.getDataset(), h),
          u = Object.keys(t0.elements[t]),
          g = () => this.getContext(i, s, e),
          f = l.resolveNamedOptions(c, u, g, d);
        return (
          f.$shared && ((f.$shared = o), (a[r] = Object.freeze(ia(f, o)))), f
        );
      }
    ...
    class iu extends ir {
      ...
      parseObjectData(t, e, i, s) {
        ...
        for (a = i, r = i + s; a < r; ++a)
          (o = e[a]),
            ((n = {})[l.axis] = l.parse(Q(o, u), a)),
            f.push(io(Q(o, g), n, h, a));
        return f;
      }
      updateRangeFromParsed(t, e, i, s) {
        ...
        for (let u = e; u < e + i; u++) {
          let e = this.getParsed(u),
            ...
            p = {
              ...
              base: i.base,
              enableBorderRadius:
                !f || ih(e._custom) || r === f._top || r === f._bottom,
              x: l ? i.head : g.center,
              y: l ? g.center : i.head,
      ...
      _getAxis() {
        ...
        for (let i of this.chart.data.datasets)
          t[
            V("x" === this.chart.options.indexAxis ? i.xAxisID : i.yAxisID, e)
          ] = !0;
        return Object.keys(t);
      }
              ...
              let e,
                ...
                n = (function (t, e) {
                  if (!t._cache.$bar) {
                    ...
                    t._cache.$bar = tL(s.sort((t, e) => t - e));
                  }
                  return t._cache.$bar;
                })(r, t.type),
                o = r._length,
                l = () => {
                  32767 !== s &&
                    -32768 !== s &&
                    (tt(a) && (o = Math.min(o, Math.abs(s - a) || o)), (a = s));
                };
      ...
      _calculateBarValuePixels(t) {
        let e,
          ...
          u = h[s.axis],
          g = 0,
          f = a ? this.applyStack(s, h, a) : u;
        f !== u && ((g = f - u), (f = u)),
          c &&
            ((u = d.barStart),
            (f = d.barEnd - d.barStart),
            0 !== u && tu(u) !== tu(d.barEnd) && (g = 0),
            (g += u));
        let p = j(n) || c ? g : n,
        ...
        if (
          ...
          let t = s.getPixelForDecimal(0),
            ...
            d = Math.min(t, n);
          (e = (m = Math.max(Math.min(m, Math.max(t, n)), d)) + i),
            a &&
              !c &&
        ...
        if (m === s.getPixelForValue(l)) {
          let t = (tu(i) * s.getLineWidthForValue(l)) / 2;
          (m += t), (i -= t);
        }
      ...
      _calculateBarIndexPixels(t, e) {
        ...
        if (e.grouped) {
          ...
          let a,
            ...
            x,
            b,
            _ = n ? this._getStackCount(t) : e.stackCount,
            y =
              "flex" === r.barThickness
                ? ((h = _ * l),
                  (c = (a = e.pixels)[t]),
                  (u = t > 0 ? a[t - 1] : null),
                  (g = t < a.length - 1 ? a[t + 1] : null),
                  (f = r.categoryPercentage),
                  null === u &&
                    (u = c - (null === g ? e.end - e.start : g - c)),
                  null === g && (g = c + c - u),
                  (p = c - ((c - Math.min(u, g)) / 2) * f),
                  {
                    chunk: ((Math.abs(g - u) / 2) * f) / h,
                    ratio: r.barPercentage,
                    start: p,
                  })
                : ((d = _ * l),
                  j((b = r.barThickness))
                    ? ((m = e.min * r.categoryPercentage),
                      (x = r.barPercentage))
                    : ((m = b * d), (x = 1)),
                  { chunk: m / d, ratio: x, start: e.pixels[t] - m / 2 }),
            v =
              "x" === this.chart.options.indexAxis
                ? this.getDataset().xAxisID
                : this.getDataset().yAxisID,
            w = this._getAxis().indexOf(
              V(v, this.getFirstScaleIdForIndexAxis()),
            ),
            M =
              this._getStackIndex(
                this.index,
          ...
          (i = y.start + y.chunk * M + y.chunk / 2),
            (s = Math.min(o, y.chunk * y.ratio));
        } else
    ...
    class ig extends ir {
      ...
      parseArrayData(t, e, i, s) {
        ...
        for (let t = 0; t < a.length; t++) {
          let s = e[i + t];
          a[t]._custom = V(s[2], this.resolveDataElementOptions(t + i).radius);
        }
        return a;
      }
      parseObjectData(t, e, i, s) {
    ...
    class ip extends ir {
      ...
      update(t) {
        let e,
          ...
          { circumference: h, rotation: d } = this._getRotationExtents(),
          {
            ...
            if (e < ta) {
              let o = t + e,
                ...
                c = Math.sin(o),
                u = (e, s, a) =>
                  tM(e, t, o, !0) ? 1 : Math.max(s, s * i, a, a * i),
                g = (e, s, a) =>
                  tM(e, t, o, !0) ? -1 : Math.min(s, s * i, a, a * i),
                f = u(0, l, d),
                p = u(tl, h, c),
                m = g(ts, l, d),
                x = g(ts + tl, h, c);
          ...
          p = Math.max(Math.min((i.width - r) / c, (i.height - r) / u) / 2, 0),
          m = B(this.options.radius, p),
          x = Math.max(m * o, 0),
      ...
      _circumference(t, e) {
        ...
        return (e && i.animation.animateRotate) ||
          ...
          s.data[t].hidden
          ? 0
          : this.calculateCircumference((s._parsed[t] * a) / ta);
      }
      updateElements(t, e, i, s) {
        let a,
          r = "reset" === s,
        ...
        for (a = e; a < e + i; ++a) {
          ...
          p &&
            (n.options =
              f || this.resolveDataElementOptions(a, i.active ? "active" : s)),
            (m += e),
      ...
      calculateCircumference(t) {
        ...
        return e > 0 && !isNaN(t) ? (Math.abs(t) / e) * ta : 0;
      }
      getLabelAndValue(t) {
        let e = this._cachedMeta,
          i = this.chart,
          s = i.data.labels || [],
          a = tq(e._parsed[t], i.options.locale);
    ...
    class im extends ir {
      ...
      getLabelAndValue(t) {
        let e = this._cachedMeta,
          i = this.chart,
          s = i.data.labels || [],
          a = tq(e._parsed[t].r, i.options.locale);
        return { label: s[t] || "", value: a };
      }
      parseObjectData(t, e, i, s) {
        return ek.bind(this)(t, e, i, s);
      }
      update(t) {
        let e = this._cachedMeta.data;
      ...
      updateElements(t, e, i, s) {
        let a,
          ...
          h = l.xCenter,
          d = l.yCenter,
          c = l.getIndexAngle(0) - 0.5 * ts,
          u = c,
          g = 360 / this.countVisibleElements();
        for (a = 0; a < e; ++a) u += this._computeAngle(a, s, g);
        for (a = e; a < e + i; a++) {
          let e = t[a],
            i = u,
            f = u + this._computeAngle(a, s, g),
            p = n.getDataVisibility(a)
              ? l.getDistanceFromCenterForValue(this.getParsed(a).r)
              : 0;
          (u = f),
            r && (o.animateScale && (p = 0), o.animateRotate && (i = f = c));
          let m = {
            x: h,
            y: d,
            innerRadius: 0,
    ...
    class ix extends ir {
      ...
      update(t) {
        ...
        if (((i.points = s), "resize" !== t)) {
          ...
          let r = { _loop: !0, _fullLoop: a.length === s.length, options: e };
    ...
    class ib extends ir {
      ...
      updateElements(t, e, i, s) {
        let a = "reset" === s,
          { iScale: r, vScale: n, _stacked: o, _dataset: l } = this._cachedMeta,
        ...
        for (let h = e; h < e + i; ++h) {
          let e = t[h],
            ...
            f = x ? e : {},
            _ = j(i[g]),
            y = (f[u] = r.getPixelForValue(i[u], h)),
            v = (f[g] =
              a || _
                ? n.getBasePixel()
                : n.getPixelForValue(o ? this.applyStack(n, i, o) : i[g], h));
          (f.skip = isNaN(y) || isNaN(v) || _),
            (f.stop = h > 0 && Math.abs(i[u] - b[u]) > m),
            p && ((f.parsed = i), (f.raw = l.data[h])),
            c &&
              (f.options =
                d ||
                this.resolveDataElementOptions(h, e.active ? "active" : s)),
            x || this.updateElement(e, h, f, s),
            (b = i);
        }
                ...
                if (l) {
                  let { vScale: e } = a._cachedMeta,
                    ...
                    r = i
                      .slice(0, s.lo + 1)
                      .reverse()
                      .findIndex((t) => !j(t[e.axis]));
                  s.lo -= Math.max(0, r);
                  let n = i.slice(s.hi).findIndex((t) => !j(t[e.axis]));
                  s.hi += Math.max(0, n);
                }
                return s;
              }
        ...
        ? "r" !== i || s
          ? ((n = []),
            ...
            iv(t, i, e, function (i, o, l) {
              ...
              let g = h(e, u);
              g < d
                ? ((n = [{ element: i, datasetIndex: o, index: l }]), (d = g))
                : g === d && n.push({ element: i, datasetIndex: o, index: l });
            }),
            n)
          : ((c = []),
            iv(t, i, e, function (t, i, s) {
              let { startAngle: r, endAngle: n } = t.getProps(
                  ["startAngle", "endAngle"],
                  a,
                ),
                { angle: o } = t_(t, { x: e.x, y: e.y });
              tM(o, r, n) && c.push({ element: t, datasetIndex: i, index: s });
            }),
            c)
        : [];
    }
    function ik(t, e, i, s, a) {
      let r = [],
        n = "x" === i ? "inXRange" : "inYRange",
        o = !1;
      return (iv(t, i, e, (t, s, l) => {
        t[n] &&
          t[n](e[i], a) &&
      ...
      modes: {
        index(t, e, i, s) {
          let a = ej(e, t),
            ...
            o = i.intersect ? iw(t, a, r, s, n) : iM(t, a, r, !1, s, n),
            l = [];
          return o.length
        ...
        point(t, e, i, s) {
          let a = ej(e, t);
          return iw(t, a, i.axis || "xy", s, i.includeInvisible || !1);
        },
        nearest(t, e, i, s) {
          let a = ej(e, t),
            r = i.axis || "xy",
            n = i.includeInvisible || !1;
          return iM(t, a, r, i.intersect, s, n);
        },
        x(t, e, i, s) {
          let a = ej(e, t);
          return ik(t, a, "x", i.intersect, s);
        },
        y(t, e, i, s) {
          let a = ej(e, t);
          return ik(t, a, "y", i.intersect, s);
        },
      },
    };
    let iP = ["left", "top", "right", "bottom"];
    function iD(t, e) {
      return t.filter((t) => t.pos === e);
    }
    function iC(t, e) {
      return t.filter((t) => -1 === iP.indexOf(t.pos) && t.box.axis === e);
    }
    function iO(t, e) {
      return t.sort((t, i) => {
        let s = e ? i : t,
    ...
    function iT(t, e, i, s) {
      ...
      for (a = 0, r = t.length, l = 0; a < r; ++a) {
        ...
        let { same: r, other: c } = (function (t, e, i, s) {
          ...
          r.getPadding && iL(n, r.getPadding());
          let o = Math.max(0, e.outerWidth - iA(n, t, "left", "right")),
            l = Math.max(0, e.outerHeight - iA(n, t, "top", "bottom")),
            h = o !== t.w,
            d = l !== t.h;
          return (
            (t.w = o),
      ...
      return (l && iT(d, e, i, s)) || h;
    }
    function iE(t, e, i, s, a) {
      (t.top = i),
        (t.left = e),
        (t.right = e + s),
        (t.bottom = i + a),
    ...
    function iR(t, e, i, s) {
      ...
      for (let o of t) {
        ...
        if (o.horizontal) {
          let s = e.w * h,
            r = l.size || t.height;
          tt(l.start) && (n = l.start),
            t.fullSize
              ? iE(t, a.left, n, i.outerWidth - a.right - a.left, r)
              : iE(t, e.left + l.placed, n, s, r),
            (l.start = n),
            (l.placed += s),
            (n = t.bottom);
        } else {
          let s = e.h * h,
            n = l.size || t.width;
          tt(l.start) && (r = l.start),
            t.fullSize
              ? iE(t, r, a.top, n, i.outerHeight - a.bottom - a.top)
              : iE(t, r, e.top + l.placed, n, s),
            (l.start = r),
            (l.placed += s),
            (r = t.right);
        }
    ...
    var ij = {
      ...
      update(t, e, i, s) {
        let a, r, n, o, l, h, d, c;
        if (!t) return;
        let u = eh(t.options.layout.padding),
          g = Math.max(e - u.width, 0),
          ...
          p =
            ...
            {
              fullSize: r,
              leftAndTop: n.concat(l),
              rightAndBottom: o.concat(c).concat(h).concat(d),
              chartArea: iD(a, "chartArea"),
              vertical: n.concat(o).concat(c),
        ...
        iL(_, eh(s));
        let y = Object.assign(
            { maxPadding: _, w: g, h: f, x: u.left, y: u.top },
            u,
          ),
          v = (function (t, e) {
            let i,
        ...
        iT(p.fullSize, y, b, v),
          iT(m, y, b, v),
          iT(x, y, b, v) && iT(m, y, b, v);
        let w = y.maxPadding;
        function M(t) {
          let e = Math.max(w[t] - y[t], 0);
          return (y[t] += e), e;
        }
        (y.y += M("top")),
          (y.x += M("left")),
          M("right"),
          M("bottom"),
          iR(p.leftAndTop, y, b, v),
          (y.x += y.w),
          (y.y += y.h),
          iR(p.rightAndBottom, y, b, v),
          (t.chartArea = {
            left: y.left,
            top: y.top,
            right: y.left + y.w,
    ...
    function iq(t, e, i) {
      ...
      return (
        n.observe(a),
        iU.size || window.addEventListener("resize", iX),
        iU.set(t, r),
        n
      );
    }
    function iK(t, e, i) {
      i && i.disconnect(),
        "resize" === e &&
          (iU.delete(t), iU.size || window.removeEventListener("resize", iX));
    }
    function iJ(t, e, i) {
      let s = t.canvas,
        a = tE((e) => {
      ...
      return s && s.addEventListener(e, a, iB), a;
    }
    class iZ extends iz {
      acquireContext(t, e) {
      ...
      releaseContext(t) {
        ...
        ["height", "width"].forEach((t) => {
          let s = i[t];
          j(s) ? e.removeAttribute(t) : e.setAttribute(t, s);
        });
        let s = i.style || {};
        return (
      ...
      addEventListener(t, e, i) {
        ...
        let s = t.$proxies || (t.$proxies = {}),
          a = { attach: iH, detach: i$, resize: iq }[e] || iJ;
        s[e] = a(t, e, i);
      }
      removeEventListener(t, e) {
        ...
        s &&
          ((
            { attach: iK, detach: iK, resize: iK }[e] ||
            function (t, e, i) {
              t && t.canvas && t.canvas.removeEventListener(e, i, iB);
            }
          )(t, e, s),
          (i[e] = void 0));
      }
      ...
      getMaximumSize(t, e, i, s) {
        return (function (t, e, i, s) {
          let a = eT(t),
            r = eR(a, "margin"),
            n = eL(a.maxWidth, t, "clientWidth") || tn,
            o = eL(a.maxHeight, t, "clientHeight") || tn,
            l = (function (t, e, i) {
              let s, a;
              if (void 0 === e || void 0 === i) {
                ...
                if (r) {
                  ...
                  (e = t.width - l.width - o.width),
                    ...
                    (s = eL(n.maxWidth, r, "clientWidth")),
                    (a = eL(n.maxHeight, r, "clientHeight"));
          ...
          if ("content-box" === a.boxSizing) {
            let t = eR(a, "border", "width"),
              e = eR(a, "padding");
            (h -= e.width + t.width), (d -= e.height + t.height);
          }
          return (
            (h = Math.max(0, h - r.width)),
            (d = Math.max(0, s ? h / s : d - r.height)),
            (h = ez(Math.min(h, n, l.maxWidth))),
            (d = ez(Math.min(d, o, l.maxHeight))),
            h && !d && (d = ez(h / 2)),
            (void 0 !== e || void 0 !== i) &&
              s &&
              l.height &&
              d > l.height &&
              (h = ez(Math.floor((d = l.height) * s))),
            { width: h, height: d }
          );
        })(t, e, i, s);
      }
    ...
    function iG(t, e, i, s, a) {
      let r,
        n,
        o,
        l = V(s, 0),
        h = Math.min(V(a, t.length), t.length),
        d = 0;
      for (
    ...
    let i0 = (t, e, i) => ("top" === e || "left" === e ? t[e] + i : t[e] - i),
    ...
    class i6 extends iQ {
      ...
      getUserBounds() {
        ...
        return (
          ...
          (i = I(i, 1 / 0)),
          (s = I(s, -1 / 0)),
          { min: I(t, i), max: I(e, s), minDefined: N(t), maxDefined: N(e) }
        );
      }
      getMinMax(t) {
        let e,
      ...
      update(t, e, i) {
        ...
        this._convertTicksToLabels(o ? i2(this.ticks, n) : this.ticks),
          this.configure(),
          ...
          r.display &&
            ...
            ((this.ticks = (function (t, e) {
              ...
              let s,
                ...
                o = Math.min(r.maxTicksLimit || n, n),
                l = r.major.enabled
                  ? (function (t) {
                      let e,
                        i,
              ...
              if (h > 0) {
                ...
                for (
                  iG(e, u, g, j(s) ? 0 : d - s, d), t = 0, i = h - 1;
                  t < i;
                  t++
                )
                  iG(e, u, g, l[t], l[t + 1]);
                return iG(e, u, g, c, j(s) ? e.length : c + s), u;
              }
              return iG(e, u, g), u;
            })(this, this.ticks)),
            (this._labelSizes = null),
      ...
      calculateLabelRotation() {
        let t,
          ...
          s = this.options,
          a = s.ticks,
          r = i1(this.ticks.length, s.ticks.maxTicksLimit),
          n = a.minRotation || 0,
          o = a.maxRotation,
          l = n;
        if (
        ...
        let h = this._getLabelSizes(),
          d = h.widest.width,
          c = h.highest.height,
          u = tk(this.chart.width - d, 0, this.maxWidth);
        d + 6 > (t = s.offset ? this.maxWidth / r : u / (r - 1)) &&
          ...
          (e =
            ...
            i5(s.grid) -
            a.padding -
            i4(s.title, this.chart.options.font)),
          (i = Math.sqrt(d * d + c * c)),
          (l = Math.max(
            n,
            Math.min(
              ...
              (l =
                (180 / ts) *
                Math.min(
                  Math.asin(tk((h.highest.height + 6) / t, -1, 1)),
                  Math.asin(tk(e / i, -1, 1)) - Math.asin(tk(c / i, -1, 1)),
                )),
            ),
          ))),
      ...
      fit() {
        let t = { width: 0, height: 0 },
          ...
          n = this.isHorizontal();
        if (r) {
          let r = i4(s, e.options.font);
          if (
            (n
              ? ((t.width = this.maxWidth), (t.height = i5(a) + r))
              : ((t.height = this.maxHeight), (t.width = i5(a) + r)),
      ...
      _computeLabelSizes(t, e, i) {
        let s,
          ...
          u,
          g,
          { ctx: f, _longestTextCache: p } = this,
          m = [],
          x = [],
          b = Math.floor(e / i1(e, i)),
          _ = 0,
          y = 0;
        for (s = 0; s < e; s += b) {
          if (
            ((n = t[s].label),
            (f.font = l = (o = this._resolveTickFontOptions(s)).string),
            (h = p[l] = p[l] || { data: {}, gc: [] }),
            (d = o.lineHeight),
            (c = u = 0),
            j(n) || z(n))
            ...
            if (z(n))
              for (a = 0, r = n.length; a < r; ++a)
                j((g = n[a])) ||
                  z(g) ||
                  ((c = t1(f, h.data, h.gc, c, g)), (u += d));
          } else (c = t1(f, h.data, h.gc, c, n)), (u = d);
          m.push(c), x.push(u), (_ = Math.max(c, _)), (y = Math.max(u, y));
        }
        H(p, (t) => {
          let i,
            s = t.gc,
      ...
      getPixelForDecimal(t) {
        ...
        return tk(
          this._alignToPixels ? t2(this.chart, e, 0) : e,
          -32768,
          32767,
        );
      }
      ...
      getContext(t) {
        ...
        if (t >= 0 && t < s.length) {
          ...
          return (
            i.$context ||
            ((e = this.getContext()),
            (i.$context = eu(e, { tick: i, index: t, type: "tick" })))
          );
        }
        return (
          this.$context ||
      ...
      _computeGridLineItems(t) {
        let e,
          ...
          f = this.chart,
          p = this.options,
          { grid: m, position: x, border: b } = p,
          _ = m.offset,
          y = this.isHorizontal(),
          v = this.ticks.length + +!!_,
          w = i5(m),
          M = [],
          k = b.setContext(this.getContext()),
        ...
        if ("top" === x)
          ...
          if ("center" === x) e = D((t.top + t.bottom) / 2 + 0.5);
          else if (F(x)) {
            let t = Object.keys(x)[0],
              i = x[t];
            e = D(this.chart.scales[t].getPixelForValue(i));
          }
          (d = t.top), (u = t.bottom), (l = (n = e + P) + w);
        } else if ("y" === g) {
          ...
          (o = (r = e - P) - w), (h = t.left), (c = t.right);
        }
        let C = V(p.ticks.maxTicksLimit, v),
      ...
      _computeLabelItems(t) {
        let e,
          ...
          u = this.axis,
          g = this.options,
          { position: f, ticks: p } = g,
          m = this.isHorizontal(),
          x = this.ticks,
          { align: b, crossAlign: _, padding: y, mirror: v } = p,
          w = i5(g.grid),
          M = w + y,
          k = v ? -y : M,
          S = -tx(this.labelRotation),
          P = [],
          D = "middle";
        if ("top" === f)
          ...
          if ("center" === f) r = (t.top + t.bottom) / 2 + M;
          else if (F(f)) {
          ...
          if ("center" === f) a = (t.left + t.right) / 2 - M;
          else if (F(f)) {
            let t = Object.keys(f)[0],
              e = f[t];
                ...
                (c =
                  "top" === f
                    ? "near" === _ || 0 !== S
                      ? -d * h + h / 2
                      : "center" === _
                        ? -C.highest.height / 2 - g * h + h
                        : -C.highest.height + h / 2
                    : "near" === _ || 0 !== S
                      ? h / 2
                      : "center" === _
                        ? C.highest.height / 2 - g * h
                        : C.highest.height - d * h),
                v && (c *= -1),
                0 === S || u.showLabelBackdrop || (a += (h / 2) * Math.sin(S)))
              : ((r = o), (c = ((1 - d) * h) / 2)),
            u.showLabelBackdrop)
          ) {
            let s = eh(u.backdropPadding),
              a = C.heights[e],
              r = C.widths[e],
              o = c - s.top,
              l = 0 - s.left;
      ...
      drawBorder() {
        ...
        let d = o.setContext(this.getContext(0)).lineWidth,
          c = this._borderValue;
        this.isHorizontal()
          ? ((t = t2(a, this.left, h) - h / 2),
            (e = t2(a, this.right, d) + d / 2),
            (i = s = c))
          : ((i = t2(a, this.top, h) - h / 2),
            (s = t2(a, this.bottom, d) + d / 2),
            (t = e = c)),
          r.save(),
          (r.lineWidth = l.width),
      ...
      drawLabels(t) {
        ...
        for (let s of (i && t8(e, i), this.getLabelItems(t))) {
          let t = s.options,
            i = s.font;
          ee(e, s.label, 0, s.textOffset, i, t);
        }
        i && t7(e);
      }
      drawTitle() {
        let t,
          ...
          {
            ctx: i,
            options: { position: s, title: a, reverse: r },
          } = this;
        if (!a.display) return;
        let n = ed(a.font),
          o = eh(a.padding),
          l = a.align,
          h = n.lineHeight / 2;
        "bottom" === s || "center" === s || F(s)
          ? ((h += o.bottom),
            z(a.text) && (h += n.lineHeight * (a.text.length - 1)))
          : (h += o.top);
        let {
          titleX: d,
          titleY: c,
          ...
          if (t.isHorizontal()) {
            if (((r = tj(s, l, d)), F(i))) {
              let t = Object.keys(i)[0],
                s = i[t];
              n = g[t].getPixelForValue(s) + p - e;
            } else
              n = "center" === i ? (u.bottom + u.top) / 2 + p - e : i0(t, i, e);
            a = d - l;
          } else {
            if (F(i)) {
              let t = Object.keys(i)[0],
                s = i[t];
              r = g[t].getPixelForValue(s) - m + e;
            } else
              r = "center" === i ? (u.left + u.right) / 2 - m + e : i0(t, i, e);
            (n = tj(s, h, o)), (f = "left" === i ? -tl : tl);
          }
          return { titleX: r, titleY: n, maxWidth: a, rotation: f };
        })(this, h, s, l);
        ee(i, a.text, 0, 0, n, {
          color: a.color,
          maxWidth: u,
      ...
      _layers() {
        ...
        return this._isVisible() && this.draw === i6.prototype.draw
          ? [
              {
                z: i,
                draw: (t) => {
      ...
      _resolveTickFontOptions(t) {
        return ed(this.options.ticks.setContext(this.getContext(t)).font);
      }
      _maxDigits() {
    ...
    class i3 {
      ...
      register(t) {
        ...
        return (
          c in d ||
            ...
            i.defaultRoutes &&
              ((r = s),
              Object.keys((n = i.defaultRoutes)).forEach((t) => {
                let e = t.split("."),
                  i = e.pop(),
                  s = [r].concat(e).join("."),
                  a = n[t].split("."),
            ...
            i.descriptors && t0.describe(s, i.descriptors),
            this.override && t0.override(t.id, t.overrides)),
          u
        );
      }
      get(t) {
      ...
      unregister(t) {
        let e = this.items,
          ...
          s = this.scope;
        i in e && delete e[i],
          s && i in t0[s] && (delete t0[s][i], this.override && delete tJ[i]);
      }
    }
    var i8 = new (class {
      constructor() {
        (this.controllers = new i3(ir, "datasets", !0)),
          (this.elements = new i3(iQ, "elements")),
          (this.plugins = new i3(Object, "plugins")),
          (this.scales = new i3(i6, "scales")),
      ...
      _createDescriptors(t, e) {
        let i = t && t.config,
          ...
          a = (function (t) {
            let e = {},
              i = [],
              s = Object.keys(i8.plugins.items);
            for (let t = 0; t < s.length; t++) i.push(i8.getPlugin(s[t]));
            let a = t.plugins || [];
            for (let t = 0; t < a.length; t++) {
              let s = a[t];
    ...
    function ss(t) {
      let e,
        ...
        s,
        a,
        r = t.options || (t.options = {});
      (r.plugins = V(r.plugins, {})),
        (e = tJ[t.type] || { scales: {} }),
        (i = r.scales || {}),
        (s = i9(t.type, r)),
          ...
          let o = se(
              ...
              (function (t, e) {
                if (e.data && e.data.datasets) {
                  ...
                  if (i.length) return si(t, "x", i[0]) || si(t, "y", i[0]);
                }
                return {};
              })(r, t),
              t0.scales[n.type],
            ...
            h = e.scales || {};
          a[r] = K(Object.create(null), [{ axis: o }, n, h[o], h[l]]);
        }),
        t.data.datasets.forEach((e) => {
          let s = e.type || t.type,
            n = e.indexAxis || i9(s, r),
            o = (tJ[s] || {}).scales || {};
          Object.keys(o).forEach((t) => {
            ...
            (a[l] = a[l] || Object.create(null)),
              K(a[l], [{ axis: r }, i[l], o[t]]);
          });
        }),
        Object.keys(a).forEach((t) => {
          let e = a[t];
          K(e, [t0.scales[e.type], t0.scale]);
        }),
        (r.scales = a);
    }
    function sa(t) {
    ...
    function so(t, e) {
      let i = sr.get(t);
      return i || ((i = e()), sr.set(t, i), sn.add(i)), i;
    }
    let sl = (t, e, i) => {
      let s = Q(e, i);
      void 0 !== s && t.add(s);
    ...
    class sh {
      constructor(t) {
        (this._config = (function (t) {
          return ((t = t || {}).data = sa(t.data)), ss(t), t;
        })(t)),
      ...
      update() {
        let t = this._config;
        this.clearCache(), ss(t);
      }
      clearCache() {
        this._scopeCache.clear(), this._resolverCache.clear();
      }
      datasetScopeKeys(t) {
        return so(t, () => [[`datasets.${t}`, ""]]);
      }
      datasetAnimationScopeKeys(t, e) {
        return so(`${t}.transition.${e}`, () => [
      ...
      getOptionScopes(t, e, i) {
        ...
        let o = new Set();
        e.forEach((e) => {
          t && (o.add(t), e.forEach((e) => sl(o, t, e))),
            e.forEach((t) => sl(o, s, t)),
            e.forEach((t) => sl(o, tJ[a] || {}, t)),
            e.forEach((t) => sl(o, t0, t)),
            e.forEach((t) => sl(o, tZ, t));
        });
        let l = Array.from(o);
        return (
      ...
      chartOptionScopes() {
        ...
        return [t, tJ[e] || {}, t0.datasets[e] || {}, { type: e }, t0, tZ];
      }
      resolveNamedOptions(t, e, i, s = [""]) {
        let a = { $shared: !0 },
          { resolver: r, subPrefixes: n } = sd(this._resolverCache, t, s),
          o = r;
        if (
          (function (t, e) {
            let { isScriptable: i, isIndexable: s } = ep(t);
            for (let a of e) {
              let e = i(a),
                r = s(a),
                n = (r || e) && t[a];
              if ((e && (te(n) || sc(n))) || (r && z(n))) return !0;
            }
            return !1;
          })(r, e)
        ) {
          (a.$shared = !1), (i = te(i) ? i() : i);
      ...
      createResolver(t, e, i = [""], s) {
        let { resolver: a } = sd(this._resolverCache, t, i);
        return F(e) ? ef(a, e, void 0, s) : a;
      }
    }
    function sd(t, e, i) {
      let s = t.get(e);
    ...
    let sc = (t) => F(t) && Object.getOwnPropertyNames(t).some((e) => te(t[e])),
      su = ["top", "bottom", "left", "right", "chartArea"];
    function sg(t, e) {
      return (
        "top" === t || "bottom" === t || (-1 === su.indexOf(t) && "x" === e)
      );
    }
    function sf(t, e) {
      return function (i, s) {
    ...
    class sy {
      ...
      constructor(t, e) {
        ...
        const n = this.platform.acquireContext(s, r.aspectRatio),
          o = n && n.canvas,
          l = o && o.height,
          h = o && o.width;
        if (
        ...
        e0.listen(this, "complete", sp),
          e0.listen(this, "progress", sm),
          this._initialize(),
      ...
      _initialize() {
        return (
          ...
          this.options.responsive
            ? this.resize()
            : eF(this, this.options.devicePixelRatio),
          this.bindEvents(),
      ...
      clear() {
        return t5(this.canvas, this.ctx), this;
      }
      stop() {
        return e0.stop(this), this;
      }
      resize(t, e) {
        e0.running(this)
        ...
        e &&
          ...
          H(a, (e) => {
            let a = e.options,
              ...
              n = se(r, a),
              o = V(a.type, e.dtype);
            (void 0 === a.position || sg(a.position, n) !== sg(e.dposition)) &&
          ...
          H(i, (t) => {
            ij.configure(this, t, t.options), ij.addBox(this, t);
          });
      }
      _updateMetasets() {
        ...
        this._sortedMetasets = t.slice(0).sort(sf("order", "index"));
      }
      ...
      buildOrUpdateControllers() {
        ...
        for (
          ...
          if (
            ...
            (a.type = r),
            (a.indexAxis = e.indexAxis || i9(r, this.options)),
            (a.order = e.order || 0),
            (a.index = t),
            (a.label = "" + e.label),
            ...
            let e = i8.getController(r),
              { datasetElementType: s, dataElementType: n } = t0.datasets[r];
            Object.assign(e, {
              dataElementType: i8.getElement(n),
              datasetElementType: s && i8.getElement(s),
            }),
      ...
      _checkEventBindings() {
        let t = this.options;
        (ti(new Set(Object.keys(this._listeners)), new Set(t.events)) &&
      ...
      _getUniformDataChanges() {
        ...
        let e = this.data.datasets.length,
          ...
          s = i(0);
        for (let t = 1; t < e; t++) if (!ti(s, i(t))) return;
        return Array.from(s)
          .map((t) => t.split(","))
      ...
      _updateLayout(t) {
        if (!1 === this.notifyPlugins("beforeLayout", { cancelable: !0 }))
          return;
        ij.update(this, this.width, this.height, t);
      ...
      _updateDatasets(t) {
        if (
          ...
          for (let e = 0, i = this.data.datasets.length; e < i; ++e)
            this._updateDataset(e, te(t) ? t({ datasetIndex: e }) : t);
      ...
      render() {
        !1 !== this.notifyPlugins("beforeRender", { cancelable: !0 }) &&
          (e0.has(this)
            ? this.attached && !e0.running(this) && e0.start(this)
            : (this.draw(), sp({ chart: this })));
      }
      draw() {
        let t;
      ...
      isPointInArea(t) {
        return t3(t, this.chartArea, this._minPadding);
      }
      ...
      getContext() {
        return (
          this.$context ||
          (this.$context = eu(null, { chart: this, type: "chart" }))
        );
      }
      ...
      _stop() {
        let t, e;
        for (
          this.stop(), e0.remove(this), t = 0, e = this.data.datasets.length;
          t < e;
          ++t
        )
      ...
      _handleEvent(t, e, i) {
        ...
        i &&
          ((this._lastEvent = null),
          W(r.onHover, [t, n, this], this),
          o && W(r.onClick, [t, n, this], this));
        let h = !$(n, a);
        return (
          (h || e) && ((this._active = n), this._updateHoverStyles(n, a, e)),
          (this._lastEvent = l),
          h
        );
      }
    ...
    function sv() {
      return H(sy.instances, (t) => t._plugins.invalidate());
    }
    function sw(t, e, i, s) {
      return { x: i + t * Math.cos(e), y: s + t * Math.sin(e) };
    }
    function sM(t, e, i, s, a, r) {
      var n, o, l, h;
      let d,
        c,
        u,
        g,
        { x: f, y: p, startAngle: m, pixelMargin: x, innerRadius: b } = e,
        _ = Math.max(e.outerRadius + s + i - x, 0),
        y = b > 0 ? b + s + i + x : 0,
        v = 0,
        w = a - m;
      if (s) {
      ...
      let M = Math.max(0.001, w * _ - i / ts) / _,
        k = (w - M) / 2,
        S = m + k + v,
        P = a - k - v,
        {
        ...
        (u = Math.min((c = (l - o) / 2), (h * o) / 2)),
        {
          outerStart: (g = (t) => {
            ...
            return tk(t, 0, Math.min(c, e));
          })(d.outerStart),
          outerEnd: g(d.outerEnd),
          innerStart: tk(d.innerStart, 0, u),
          innerEnd: tk(d.innerEnd, 0, u),
        }),
        L = _ - D,
        T = _ - C,
        E = S + D / L,
      ...
      if ((t.beginPath(), r)) {
        let e = (E + R) / 2;
        if ((t.arc(f, p, _, E, e), t.arc(f, p, _, e, R), C > 0)) {
          let e = sw(T, R, f, p);
          t.arc(e.x, e.y, C, R, P + tl);
        }
        let i = sw(z, P, f, p);
        if ((t.lineTo(i.x, i.y), A > 0)) {
          let e = sw(z, N, f, p);
          t.arc(e.x, e.y, A, P + tl, N + Math.PI);
        }
        let s = (P - A / y + (S + O / y)) / 2;
        if (
          (t.arc(f, p, y, P - A / y, s, !0),
          t.arc(f, p, y, s, S + O / y, !0),
          O > 0)
        ) {
          let e = sw(j, F, f, p);
          t.arc(e.x, e.y, O, F + Math.PI, S - tl);
        }
        let a = sw(L, S, f, p);
        if ((t.lineTo(a.x, a.y), D > 0)) {
          let e = sw(L, E, f, p);
          t.arc(e.x, e.y, D, S - tl, E);
        }
      } else {
        t.moveTo(f, p);
        let e = Math.cos(E) * _ + f,
          i = Math.sin(E) * _ + p;
        t.lineTo(e, i);
        let s = Math.cos(R) * _ + f,
          a = Math.sin(R) * _ + p;
        t.lineTo(s, a);
      }
      t.closePath();
    ...
    function sD(t, e, i, s) {
      let a,
        ...
        { count: h, start: d, loop: c, ilen: u } = sP(o, i, s),
        g = l.stepped
          ? t9
      ...
      for (a = 0; a <= u; ++a)
        (r = o[(d + (p ? u - a : a)) % h]).skip ||
          (f ? (t.moveTo(r.x, r.y), (f = !1)) : g(t, n, r, p, l.stepped),
          (n = r));
      return c && g(t, n, (r = o[(d + (p ? u : 0)) % h]), p, l.stepped), !!c;
    }
    function sC(t, e, i, s) {
      let a,
        r,
        ...
        h,
        d = e.points,
        { count: c, start: u, ilen: g } = sP(d, i, s),
        { move: f = !0, reverse: p } = s || {},
        m = 0,
        x = 0,
        b = (t) => (u + (p ? g - t : t)) % c,
      ...
      for (f && ((r = d[b(0)]), t.moveTo(r.x, r.y)), a = 0; a <= g; ++a) {
        if ((r = d[b(a)]).skip) continue;
        let e = r.x,
          i = r.y,
          s = 0 | e;
        s === n
          ? (i < o ? (o = i) : i > l && (l = i), (m = (x * m + e) / ++x))
          : (_(), t.lineTo(e, i), (n = s), (x = 0), (o = l = i)),
          (h = i);
      }
      _();
    }
    ...
    class sL extends iQ {
          ...
          !(function (t, e, i, s, a) {
            ...
            if (
                ...
                !(function (t, e, i) {
                  ...
                  (function (t, e, i = "x") {
                    let s,
                      ...
                      l = eP(t, 0);
                    for (let h = 0; h < o; ++h) {
                      if (((a = r), (r = l), (l = eP(t, h + 1)), !r)) continue;
                      let o = r[i],
                        d = r[n];
                      a &&
                        ((s = (o - a[i]) / 3),
              ...
              for (r = 0, n = t.length; r < n; ++r)
                ...
                })(i, (o = t[r]), t[Math.min(r + 1, n - !s) % n], e.tension)),
                  (o.cp1x = l.previous.x),
                  (o.cp1y = l.previous.y),
                  (o.cp2x = l.next.x),
                  (o.cp2y = l.next.y),
                ...
                for (i = 0, s = t.length; i < s; ++i)
                  (n = r),
                    ...
                    r &&
                      ((a = t[i]),
                      n &&
                        ((a.cp1x = eC(a.cp1x, e.left, e.right)),
                        (a.cp1y = eC(a.cp1y, e.top, e.bottom))),
                      o &&
                        ((a.cp2x = eC(a.cp2x, e.left, e.right)),
                        (a.cp2y = eC(a.cp2y, e.top, e.bottom))));
              })(t, i);
      ...
      get segments() {
        return (
          ...
          (this._segments = (function (t, e) {
            ...
            if (!0 === s) return eJ(t, [{ start: n, end: o, loop: r }], i, e);
            let l = o < n ? o + a : o,
            ...
            return eJ(
              ...
              (function (t, e, i, s) {
                ...
                return (
                  null !== o && n.push({ start: e % r, end: o % r, loop: s }), n
                );
              })(i, n, l, h),
              i,
              e,
      ...
      interpolate(t, e) {
        let i,
          ...
          r = t[e],
          n = this.points,
          o = eK(this, { property: e, start: r, end: r });
        if (!o.length) return;
        let l = [],
          h = a.stepped
            ? eB
    ...
    function sj(t, e, i, s) {
      let a = null === e,
        ...
        n = t && !(a && r) && sE(t, s);
      return (
        n && (a || tS(e, n.left, n.right)) && (r || tS(i, n.top, n.bottom))
      );
    }
    function sz(t, e) {
    ...
    class sN extends iQ {
      ...
      draw(t) {
        ...
        let a,
          ...
          {
            inflateAmount: u,
            options: { borderColor: g, backgroundColor: f },
          } = this,
          { inner: p, outer: m } =
            ((r = (a = sE(this)).right - a.left),
            (n = a.bottom - a.top),
            (e = r / 2),
            (i = n / 2),
            ...
            (h = eo(o)),
            (d = {
              t: sR(l.top, h.top, 0, i),
              r: sR(l.right, h.right, 0, e),
              b: sR(l.bottom, h.bottom, 0, i),
              l: sR(l.left, h.left, 0, e),
            }),
            (c = (function (t, e, i) {
              let { enableBorderRadius: s } = t.getProps([
                ...
                l = s || F(a);
              return {
                topLeft: sR(!l || o.top || o.left, r.topLeft, 0, n),
                topRight: sR(!l || o.top || o.right, r.topRight, 0, n),
                bottomLeft: sR(!l || o.bottom || o.left, r.bottomLeft, 0, n),
                bottomRight: sR(!l || o.bottom || o.right, r.bottomRight, 0, n),
              };
            })(this, r / 2, n / 2)),
            {
              outer: { x: a.left, y: a.top, w: r, h: n, radius: c },
              inner: {
                x: a.left + d.l,
                y: a.top + d.t,
                w: r - d.l - d.r,
    ...
    let sI = [
      ...
      sV = sI.map((t) => t.replace("rgb(", "rgba(").replace(")", ", 0.5)")),
      sB = (t, e) => {
    ...
    class sW extends iQ {
      ...
      fit() {
        ...
        let a = i.labels,
          ...
          { boxWidth: l, itemHeight: h } = sB(a, n);
        (s.font = r.string),
          this.isHorizontal()
      ...
      _fitRows(t, e, i, s) {
        ...
        return (
          this.legendItems.forEach((t, g) => {
            ...
            (0 === g || l[l.length - 1] + f + 2 * n > r) &&
              ((d += h), (l[l.length - (g > 0 ? 0 : 1)] = 0), (u += h), c++),
              (o[g] = { left: 0, top: u, row: c, width: f, height: s }),
              (l[l.length - 1] += f + n);
          }),
          d
        );
              ...
              { itemWidth: O, itemHeight: A } =
                ...
                (_ = s),
                {
                  itemWidth:
                    ...
                    v + w.size / 2 + M.measureText(D).width),
                  itemHeight:
                    ((k = _),
                    (S = b),
                    (P = m.lineHeight),
                    (C = k),
                    "string" != typeof S.text && (C = sH(S, P)),
                    C),
                });
            r > 0 &&
              u + A + 2 * n > h &&
              ...
              f++,
              (c = u = 0)),
              (o[r] = { left: g, top: u, col: f, width: O, height: A }),
              (c = Math.max(c, O)),
              (u += A + n);
          }),
          (d += c),
      ...
      adjustHitBoxes() {
        ...
        let t = this._computeTitleHeight(),
          ...
          r = eH(a, this.left, this.width);
        if (this.isHorizontal()) {
          let a = 0,
            n = tj(i, this.left + s, this.right - this.lineWidths[a]);
          for (let o of e)
            a !== o.row &&
              ((a = o.row),
              (n = tj(i, this.left + s, this.right - this.lineWidths[a]))),
      ...
      _draw() {
        ...
        this.drawTitle(),
          ...
          (a.lineWidth = 0.5),
          (a.font = h.string);
        let { boxWidth: g, boxHeight: f, itemHeight: p } = sB(n, c),
          m = function (t, e, i) {
            if (isNaN(g) || g <= 0 || isNaN(f) || f < 0) return;
            a.save();
            let s = V(i.lineWidth, 1);
            if (
              ((a.fillStyle = V(i.fillStyle, o)),
              (a.lineCap = V(i.lineCap, "butt")),
              (a.lineDashOffset = V(i.lineDashOffset, 0)),
              (a.lineJoin = V(i.lineJoin, "miter")),
              (a.lineWidth = s),
              (a.strokeStyle = V(i.strokeStyle, o)),
              a.setLineDash(V(i.lineDash, [])),
              n.usePointStyle)
            )
              t6(
                a,
              ...
              let r = e + Math.max((c - f) / 2, 0),
                n = l.leftForLtr(t, g),
                o = el(i.borderRadius);
              a.beginPath(),
                Object.values(o).some((t) => 0 !== t)
                  ? ei(a, { x: n, y: r, w: g, h: f, radius: o })
                  : a.rect(n, r, g, f),
                a.fill(),
                0 !== s && a.stroke();
            }
        ...
        (t = b
          ? {
              x: tj(r, this.left + d, this.right - s[0]),
              y: this.top + d + _,
              line: 0,
            }
          : {
              x: this.left + d,
              y: tj(r, this.top + _ + d, this.bottom - i[0].height),
              line: 0,
            }),
          e$(this.ctx, e.textDirection);
        let y = p + d;
        this.legendItems.forEach((o, c) => {
          var f, p;
          (a.strokeStyle = o.fontColor), (a.fillStyle = o.fontColor);
          let v = a.measureText(o.text).width,
            w = l.textAlign(o.textAlign || (o.textAlign = n.textAlign)),
            M = g + u + v,
            k = t.x,
            S = t.y;
          if (
            ...
            b
              ? c > 0 &&
                ...
                ((S = t.y += y),
                t.line++,
                (k = t.x = tj(r, this.left + d, this.right - s[t.line])))
              : c > 0 &&
                S + y > this.bottom &&
                ((k = t.x = k + i[t.line].width + d),
                t.line++,
                (S = t.y =
                  tj(r, this.top + _ + d, this.bottom - i[t.line].height))),
            m(l.x(k), S, o),
            (f = k + g + u),
            (p = b ? k + M : this.right),
            (k =
      ...
      drawTitle() {
        let t,
          ...
          a = eh(i.padding);
        if (!i.display) return;
        let r = eH(e.rtl, this.left, this.width),
          n = this.ctx,
          o = i.position,
          l = s.size / 2,
          h = a.top + l,
    ...
    class s$ extends iQ {
      ...
      update(t, e) {
        ...
        let s = z(i.text) ? i.text.length : 1;
        this._padding = eh(i.padding);
        let a = s * ed(i.font).lineHeight + this._padding.height;
      ...
      _drawArgs(t) {
        let e,
          i,
          s,
          { top: a, left: r, bottom: n, right: o, options: l } = this,
          h = l.align,
          d = 0;
        return (
          this.isHorizontal()
            ? ((i = tj(h, r, o)), (s = a + t), (e = o - r))
            : ("left" === l.position
                ? ((i = r + t), (s = tj(h, n, a)), (d = -0.5 * ts))
                : ((i = o - t), (s = tj(h, a, n)), (d = 0.5 * ts)),
              (e = n - a)),
    ...
    function sq(t, e) {
      ...
      (x += t.beforeBody.length + t.afterBody.length),
        ...
        x &&
          (p +=
            g * (e.displayColors ? Math.max(o, l.lineHeight) : l.lineHeight) +
            (x - g) * l.lineHeight +
            (x - 1) * e.bodySpacing),
        u &&
          (p +=
    ...
    function sJ(t, e, i, s) {
      let { caretSize: a, caretPadding: r, cornerRadius: n } = t,
        { xAlign: o, yAlign: l } = i,
        h = a + r,
        { topLeft: d, topRight: c, bottomLeft: u, bottomRight: g } = el(n),
        f = (function (t, e) {
          let { x: i, width: s } = t;
      ...
      return (
        "center" === l
          ...
          : "left" === o
            ? (f -= Math.max(d, u) + a)
            : "right" === o && (f += Math.max(c, g) + a),
        { x: tk(f, 0, s.width - e.width), y: tk(p, 0, s.height - e.height) }
      );
    }
    function sZ(t, e, i) {
      let s = eh(i.padding);
    ...
    function s0(t, e, i, s) {
      let a = t[e].call(i, s);
      return void 0 === a ? sG[e].call(i, s) : a;
    }
    class s1 extends iQ {
      static positioners = sU;
      constructor(t) {
        super(),
          (this.opacity = 0),
          (this._active = []),
      ...
      getTitle(t, e) {
        let { callbacks: i } = e,
          s = s0(i, "beforeTitle", this, t),
          a = s0(i, "title", this, t),
          r = s0(i, "afterTitle", this, t),
          n = [];
        return (n = sY(n, sX(s))), (n = sY(n, sX(a))), (n = sY(n, sX(r)));
      }
      getBeforeBody(t, e) {
        return sY([], sX(s0(e.callbacks, "beforeBody", this, t)));
      }
      getBody(t, e) {
        let { callbacks: i } = e,
          s = [];
        return (
          H(t, (t) => {
            let e = { before: [], lines: [], after: [] },
              a = sQ(i, t);
            sY(e.before, sX(s0(a, "beforeLabel", this, t))),
              sY(e.lines, s0(a, "label", this, t)),
              sY(e.after, sX(s0(a, "afterLabel", this, t))),
              s.push(e);
          }),
          s
        );
      ...
      getAfterBody(t, e) {
        return sY([], sX(s0(e.callbacks, "afterBody", this, t)));
      }
      getFooter(t, e) {
        let { callbacks: i } = e,
          s = s0(i, "beforeFooter", this, t),
          a = s0(i, "footer", this, t),
          r = s0(i, "afterFooter", this, t),
          n = [];
        return (n = sY(n, sX(s))), (n = sY(n, sX(a))), (n = sY(n, sX(r)));
      }
      _createItems(t) {
        ...
        return (
          ...
          H(l, (e) => {
            let i = sQ(t.callbacks, e);
            r.push(s0(i, "labelColor", this, e)),
              n.push(s0(i, "labelPointStyle", this, e)),
              o.push(s0(i, "labelTextColor", this, e));
          }),
          (this.labelColors = r),
      ...
      update(t, e) {
        let i,
          ...
          r = [];
        if (a.length) {
          let t = sU[s.position].call(this, a, this._eventPosition);
          ...
          let e = (this._size = sq(this, s)),
            n = Object.assign({}, t, e),
            o = sK(this.chart, s, n),
            l = sJ(s, n, o, this.chart);
      ...
      getCaretPosition(t, e, i) {
        let s,
          ...
          { topLeft: g, topRight: f, bottomLeft: p, bottomRight: m } = el(u),
          { x: x, y: b } = t,
          { width: _, height: y } = e;
        return (
          "center" === d
      ...
      _drawColorBox(t, e, i, s, a) {
        ...
        if (a.usePointStyle) {
          ...
          Object.values(n).some((t) => 0 !== t)
            ? (t.beginPath(),
              (t.fillStyle = a.multiKeyBackground),
              ei(t, { x: e, y: g, w: l, h: o, radius: n }),
              t.fill(),
              t.stroke(),
              (t.fillStyle = r.backgroundColor),
              t.beginPath(),
              ei(t, { x: i, y: g + 1, w: l - 2, h: o - 2, radius: n }),
              t.fill())
            : ((t.fillStyle = a.multiKeyBackground),
              t.fillRect(e, g, l, o),
              t.strokeRect(e, g, l, o),
              (t.fillStyle = r.backgroundColor),
              t.fillRect(i, g + 1, l - 2, o - 2));
        }
      ...
      drawBody(t, e, i) {
        let s,
          ...
          y = function (i) {
            e.fillText(i, _.x(t.x + b), t.y + x / 2), (t.y += x + d);
          },
          v = _.textAlign(c);
        for (
          e.textAlign = c,
            ...
            H(this.beforeBody, y),
            b =
              u && "right" !== v ? ("center" === c ? f / 2 + p : f + 2 + p) : 0,
            r = 0,
            o = h.length;
          r < o;
          ++r
          ...
          for (
            s = h[r],
              ...
              u &&
                a.length &&
                (this._drawColorBox(e, t, r, _, i),
                (x = Math.max(m.lineHeight, g))),
              n = 0,
              l = a.length;
            n < l;
            ++n
          )
            y(a[n]), (x = m.lineHeight);
          H(s.after, y);
        }
        (b = 0), (x = m.lineHeight), H(this.afterBody, y), (t.y -= d);
      }
      drawFooter(t, e, i) {
        let s,
          a,
      ...
      _updateAnimationTarget(t) {
        let e = this.chart,
          ...
          a = i && i.y;
        if (s || a) {
          let i = sU[t.position].call(this, this._active, this._eventPosition);
          if (!i) return;
          let r = (this._size = sq(this, t)),
    ...
    function s5(t, e, { horizontal: i, minRotation: s }) {
      let a = tx(s),
        r = (i ? Math.sin(a) : Math.cos(a)) || 0.001,
        n = 0.75 * e * ("" + t).length;
      return Math.min(e / r, n);
    }
    class s4 extends i6 {
      constructor(t) {
        super(t),
      ...
      buildTicks() {
        let t = this.options,
          ...
          s = (function (t, e) {
            ...
            let a,
              ...
              P = (w - v) / (x + 1),
              D = tf((w - v) / y / _) * _;
            if (D < 1e-14 && !M && !k) return [{ value: v }, { value: w }];
            (o = Math.ceil(w / D) - Math.floor(v / D)) > y &&
              (D = tf((o * D) / y / _) * _),
              j(f) || (D = Math.ceil(D * (a = Math.pow(10, f))) / a),
              "ticks" === d
                ? ((r = Math.floor(v / D) * D), (n = Math.ceil(w / D) * D))
                : ((r = v), (n = w)),
              M &&
              k &&
              c &&
              ...
              (l = Math.round(i)) - s <= i && l + s >= i)
                ? ((o = Math.round(Math.min((g - u) / D, m))),
                  (D = (g - u) / o),
                  (r = u),
                  (n = g))
                : S
                  ? ((r = M ? u : r), (D = ((n = k ? g : n) - r) / (o = p - 1)))
                  : (o = tg((o = (n - r) / D), Math.round(o), D / 1e3)
                      ? Math.round(o)
                      : Math.ceil(o));
            let C = Math.max(tb(D), tb(r));
            (r = Math.round(r * (a = Math.pow(10, j(f) ? C : f))) / a),
              (n = Math.round(n * a) / a);
            let O = 0;
            for (
              M &&
              (b && r !== u
                ? (h.push({ value: u }),
                  r < u && O++,
                  tg(Math.round((r + O * D) * a) / a, u, s5(u, P, t)) && O++)
                : r < u && O++);
              O < o;
              ++O
            ) {
              let t = Math.round((r + O * D) * a) / a;
              if (k && t > g) break;
              h.push({ value: t });
            }
            return (
              k && b && n !== g
                ? h.length && tg(h[h.length - 1].value, g, s5(g, P, t))
                  ? (h[h.length - 1].value = g)
                  : h.push({ value: g })
                : (k && n !== g) || h.push({ value: n }),
              h
            );
          })(
            {
        ...
        return (
          "ticks" === t.bounds && tm(s, this, "value"),
          t.reverse
      ...
      getLabelForValue(t) {
        return tq(t, this.chart.options.locale, this.options.ticks.format);
      }
    }
    class s6 extends s4 {
      static id = "linear";
      static defaults = { ticks: { callback: tK.numeric } };
      determineDataLimits() {
    ...
    let s3 = (t) => Math.floor(tc(t)),
      s8 = (t, e) => Math.pow(10, s3(t) + e);
    function s7(t) {
      return 1 == t / Math.pow(10, s3(t));
    }
    function s9(t, e, i) {
      let s = Math.pow(10, i),
        a = Math.floor(t / s);
    ...
    class at extends i6 {
      ...
      static defaults = {
        ticks: { callback: tK.logarithmic, major: { enabled: !0 } },
      };
      constructor(t) {
        super(t),
          (this.start = void 0),
      ...
      parse(t, e) {
        let i = s4.prototype.parse.apply(this, [t, e]);
        if (0 === i) {
          this._zero = !0;
          return;
        }
        return N(i) && i > 0 ? i : null;
      }
      determineDataLimits() {
        let { min: t, max: e } = this.getMinMax(!0);
        (this.min = N(t) ? Math.max(0, t) : null),
          ...
          this._zero &&
            ...
            !N(this._userMin) &&
            (this.min =
              t === s8(this.min, 0) ? s8(this.min, -1) : s8(this.min, 0)),
          this.handleTickRangeOptions();
      }
      handleTickRangeOptions() {
        let { minDefined: t, maxDefined: e } = this.getUserBounds(),
          ...
          a = (e) => (i = t ? i : e),
          r = (t) => (s = e ? s : t);
        i === s && (i <= 0 ? (a(1), r(10)) : (a(s8(i, -1)), r(s8(s, 1)))),
          i <= 0 && a(s8(s, -1)),
          s <= 0 && r(s8(i, 1)),
          (this.min = i),
          (this.max = s);
        ...
        let t = this.options,
          e = (function (t, { min: e, max: i }) {
            ...
            let s = [],
              ...
              u = I(t.min, Math.round((l + d + c * Math.pow(10, r)) * n) / n);
            for (; u < i; )
              s.push({ value: u, major: s7(u), significand: c }),
                c >= 10 ? (c = c < 15 ? 15 : 20) : c++,
                c >= 20 && ((c = 2), (n = ++r >= 0 ? 1 : n)),
                (u = Math.round((l + d + c * Math.pow(10, r)) * n) / n);
            let g = I(t.max, u);
            return s.push({ value: g, major: s7(g), significand: c }), s;
          })({ min: this._userMin, max: this._userMax }, this);
        return (
          "ticks" === t.bounds && tm(e, this, "value"),
          t.reverse
      ...
      getLabelForValue(t) {
        return void 0 === t
          ? "0"
          : tq(t, this.chart.options.locale, this.options.ticks.format);
      }
      configure() {
        let t = this.min;
        super.configure(),
          (this._startValue = tc(t)),
          (this._valueRange = tc(this.max) - tc(t));
      }
      getPixelForValue(t) {
        ...
        null === t || isNaN(t))
          ...
          : this.getPixelForDecimal(
              t === this.min
                ? 0
                : (tc(t) - this._startValue) / this._valueRange,
            );
      }
      getValueForPixel(t) {
    ...
    function ae(t) {
      ...
      if (e.display && t.display) {
        let t = eh(e.backdropPadding);
        return V(e.font && e.font.size, t0.font.size) + t.height;
      }
      return 0;
    }
    function ai(t, e, i, s, a) {
      return t === s || t === a
    ...
    function as(t, e, i, s) {
      let { ctx: a } = t;
      if (i) a.arc(t.xCenter, t.yCenter, e, 0, ta);
      else {
    ...
    class aa extends s4 {
      ...
      static defaults = {
        ...
        grid: { circular: !1 },
        startAngle: 0,
        ticks: { showLabelBackdrop: !0, callback: tK.numeric },
        pointLabels: {
      ...
      setDimensions() {
        let t = (this._padding = eh(ae(this.options) / 2)),
      ...
      generateTickLabels(t) {
        s4.prototype.generateTickLabels.call(this, t),
        ...
        t.display && t.pointLabels.display
          ? (function (t) {
              ...
              for (let d = 0; d < r; d++) {
                ...
                s[d] = g;
                let f = tw(t.getIndexAngle(d) + o),
                  p = Math.round((180 / ts) * f);
                !(function (t, e, i, s, a) {
                  ...
                  s.start < e.l
                    ...
                    : s.end > e.r &&
                      ((o = (s.end - e.r) / r), (t.r = Math.max(t.r, e.r + o))),
                    a.start < e.t
                      ? ((l = (e.t - a.start) / n),
                ...
                })(i, e, f, ai(p, c.x, g.w, 0, 180), ai(p, c.y, g.h, 90, 270));
              }
              t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b),
                (t._pointLabelItems = (function (t, e, i) {
                  let s,
                    ...
                    h = { extra: ae(n) / 2, additionalAngle: o ? ts / r : 0 };
                  for (let n = 0; n < r; n++) {
                    ...
                    let r = (function (t, e, i) {
                      ...
                      let d = t.drawingArea,
                        ...
                        p = t.getPointPosition(e, d + c + g, u),
                        m = Math.round((180 / ts) * tw(p.angle + tl)),
                        x =
                          ((s = p.y),
                          (a = f.h),
                          90 === (r = m) || 270 === r
      ...
      getIndexAngle(t) {
        return tw(
          t * (ta / (this._pointLabels.length || 1)) +
      ...
      getPointLabelContext(t) {
        ...
        if (t >= 0 && t < e.length) {
          ...
          return (
            (i = this.getContext()),
            eu(i, { label: s, index: t, type: "pointLabel" })
          );
        }
      }
      getPointPosition(t, e, i = 0) {
        let s = this.getIndexAngle(t) - tl + i;
        return {
              ...
              for (let a = e - 1; a >= 0; a--) {
                ...
                !(function (t, e, i) {
                  let { left: s, top: a, right: r, bottom: n } = i,
                    { backdropColor: o } = e;
                  if (!j(o)) {
                    let i = el(e.borderRadius),
                      l = eh(e.backdropPadding);
                    t.fillStyle = o;
                    let h = s - l.left,
                      d = a - l.top,
                      c = r - s + l.width,
                ...
                ee(i, t._pointLabels[a], o, l + n.lineHeight / 2, n, {
                  color: r.color,
                  textAlign: h,
                  textBaseline: "middle",
                });
        ...
        i.save(),
          ...
          this.ticks.forEach((r, n) => {
            ...
            let o = a.setContext(this.getContext(n)),
              l = ed(o.font);
            if (
              ((t = this.getDistanceFromCenterForValue(this.ticks[n].value)),
              o.showLabelBackdrop)
            ) {
              (i.font = l.string),
                (e = i.measureText(r.label).width),
                (i.fillStyle = o.backdropColor);
              let s = eh(o.backdropPadding);
              i.fillRect(
                -e / 2 - s.left,
                -t - l.size / 2 - s.top,
                e + s.width,
    ...
    function al(t, e) {
      ...
      N(n) || (n = "string" == typeof s ? i.parse(n, s) : i.parse(n)),
      null === n)
        ? null
        : (a &&
            (n =
    ...
    function ah(t, e, i, s) {
      let a = an.length;
      for (let r = an.indexOf(t); r < a - 1; ++r) {
        let t = ar[an[r]],
          a = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
        if (t.common && Math.ceil((i - e) / (a * t.size)) <= s) return an[r];
      }
      return an[a - 1];
    }
    function ad(t, e, i) {
    ...
    class au extends i6 {
      ...
      init(t, e = {}) {
        let i = t.time || (t.time = {}),
          s = (this._adapter = new iy(t.adapters.date));
        s.init(e),
      ...
      buildTicks() {
        ...
        return (
          (this._unit =
            e.unit ||
            (i.autoSkip
              ? ah(e.minUnit, this.min, this.max, this._getLabelCapacity(a))
              : (function (t, e, i, s, a) {
                  for (let r = an.length - 1; r >= an.indexOf(i); r--) {
                    let i = an[r];
                    if (ar[i].common && t._adapter.diff(a, s, i) >= e - 1)
                      return i;
                  }
                  return an[i ? an.indexOf(i) : 0];
                })(this, r.length, e.minUnit, this.min, this.max))),
          (this._majorUnit =
            i.major.enabled && "year" !== this._unit
              ? (function (t) {
                  for (let e = an.indexOf(t) + 1, i = an.length; e < i; ++e)
                    if (ar[an[e]].common) return an[e];
                })(this._unit)
              : void 0),
          this.initOffsets(s),
          t.reverse && r.reverse(),
          ac(this, r, this._majorUnit)
        );
      }
      afterAutoSkip() {
      ...
      _generate() {
        let t,
          ...
          r = this.options,
          n = r.time,
          o = n.unit || ah(n.minUnit, s, a, this._getLabelCapacity(s)),
        ...
        let g = "data" === r.ticks.source && this.getDataTimestamps();
        for (t = u, e = 0; t < a; t = +i.add(t, l, o), e++) ad(c, t, g);
        return (
          (t === a || "ticks" === r.bounds || 1 === e) && ad(c, t, g),
          Object.keys(c)
            .sort(ao)
            .map((t) => +t)
        );
      ...
      _getLabelCapacity(t) {
        let e = this.options.time,
          ...
          a = this._tickFormatFunction(t, 0, ac(this, [t], this._majorUnit), s),
    ...
    function ag(t, e, i) {
      ...
      i
        ? (e >= t[o].pos &&
            e <= t[l].pos &&
            ({ lo: o, hi: l } = tD(t, "pos", e)),
          ({ pos: s, time: r } = t[o]),
          ({ pos: a, time: n } = t[l]))
        : (e >= t[o].time &&
            e <= t[l].time &&
            ({ lo: o, hi: l } = tD(t, "time", e)),
          ({ time: s, pos: r } = t[o]),
          ({ time: a, pos: n } = t[l]));
      let h = a - s;
    ...
    class af extends au {
      ...
      initOffsets() {
        ...
        (this._minPos = ag(e, this.min)),
          (this._tableRange = ag(e, this.max) - this._minPos),
          super.initOffsets(t);
      }
      buildLookupTable(t) {
        let e,
      ...
      getDecimalForValue(t) {
        return (ag(this._table, t) - this._minPos) / this._tableRange;
      }
      getValueForPixel(t) {
        let e = this._offsets,
          i = this.getDecimalForPixel(t) / e.factor - e.end;
        return ag(this._table, i * this._tableRange + this._minPos, !0);
      }
    }
    let ap = "label";
    function am(t, e) {
    ...
    let ab = (0, a.forwardRef)(function (t, e) {
      let {
          height: i = 150,
          width: r = 300,
          redraw: n = !1,
        ...
        x = () => {
          p.current &&
            ((m.current = new sy(p.current, {
              type: l,
              data: (function (t, e = ap) {
                let i = { labels: [], datasets: [] };
                return (i.labels = t.labels), ax(i, t.datasets, e), i;
              })(h, o),
              options: d && { ...d },
              plugins: c,
            })),
        ...
        b = () => {
          am(e, null), m.current && (m.current.destroy(), (m.current = null));
        };
      return (
        (0, a.useEffect)(() => {
          var t;
          ...
          !n &&
            m.current &&
            d &&
            ((t = m.current), (e = t.options) && d && Object.assign(e, d));
        }, [n, d]),
        (0, a.useEffect)(() => {
          !n && m.current && (m.current.config.data.labels = h.labels);
        }, [n, h.labels]),
        (0, a.useEffect)(() => {
          !n &&
            m.current &&
            h.datasets &&
            ax(m.current.config.data, h.datasets, o);
        }, [n, h.datasets]),
        (0, a.useEffect)(() => {
          m.current && (n ? (b(), setTimeout(x)) : m.current.update(g));
        }, [n, d, h.labels, h.datasets, g]),
        (0, a.useEffect)(() => {
          m.current && (b(), setTimeout(x));
        }, [l]),
        (0, a.useEffect)(() => (x(), () => b()), []),
        (0, s.jsx)("canvas", {
          ref: p,
    ...
    function a_(t, e) {
      return (
        sy.register(e),
        (0, a.forwardRef)((e, i) => (0, s.jsx)(ab, { ...e, ref: i, type: t }))
      );
    }
    let ay = a_(
        "line",
          ...
          updateElements(t, e, i, s) {
            ...
            for (let i = 0; i < b; ++i) {
              ...
              let y = this.getParsed(i),
                v = j(y[u]),
                w = (b[c] = r.getPixelForValue(y[c], i)),
                M = (b[u] =
                  a || v
                    ? n.getBasePixel()
                    : n.getPixelForValue(
              ...
              (b.skip = isNaN(w) || isNaN(M) || v),
                (b.stop = i > 0 && Math.abs(y[c] - _[c]) > p),
                f && ((b.parsed = y), (b.raw = l.data[i])),
                d &&
                  (b.options =
                    h ||
    ...
    function aj() {
      let [t, e] = (0, a.useState)(!0),
        ...
        [h, d] = (0, a.useState)(null);
      if (
        ((0, a.useEffect)(() => {
          (async () => {
            try {
              let t = document.documentElement.classList.contains("dark");
              d((0, aR.getChartColors)(t));
              let i = await r.api.getDashboardData("student");
              l(i), e(!1);
            } catch (t) {
              console.error("Dashboard initialization error:", t),
                n(t.message || "An error occurred while loading the dashboard"),
                e(!1);
            }
          })();
        ...
        return (0, s.jsx)("div", {
          ...
          children: (0, s.jsx)("div", {
            className:
              "animate-spin rounded-full h-12 w-12 border-b-2 border-amber-500",
          }),
        });
      if (i)
        return (0, s.jsx)("div", {
          ...
          children: (0, s.jsxs)("div", {
            className:
              "text-center p-8 bg-red-50 dark:bg-red-900/20 rounded-xl border border-red-200 dark:border-red-800",
            children: [
              (0, s.jsx)("h2", {
                className:
                  "text-xl font-bold text-red-600 dark:text-red-400 mb-2",
                children: "Error",
              }),
              (0, s.jsx)("p", {
              ...
              (0, s.jsx)("button", {
                ...
                className:
                  "mt-4 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700",
                children: "Retry",
              }),
            ],
          }),
          ...
          datasets: [
            {
              ...
              data: [5, 8, 10, 14],
              borderColor: h?.primary || "#fbbf24",
              backgroundColor: h?.background || "rgba(251, 191, 36, 0.2)",
              tension: 0.4,
              fill: !0,
              pointBackgroundColor: h?.primary || "#fbbf24",
            },
          ],
        },
        u = {
          ...
          datasets: [
            {
              data: [o?.overallMastery || 0, 100 - (o?.overallMastery || 0)],
              backgroundColor: [h?.primary || "#fbbf24", "#e5e7eb"],
              borderWidth: 0,
            },
          ],
        };
        ...
        children: [
          (0, s.jsxs)("div", {
            ...
            children: [
              (0, s.jsxs)("h1", {
                className:
                  "text-3xl md:text-4xl font-bold mb-2 text-gray-900 dark:text-white",
                children: [
                  "Welcome back, ",
                  (0, s.jsx)("span", {
              ...
              (0, s.jsx)("p", {
                ...
                children: "Here's your personalized learning snapshot.",
              }),
            ],
          }),
          (0, s.jsxs)("div", {
            ...
            children: [
              (0, s.jsxs)("div", {
                className:
                  "glass-card p-5 hover:border-lumina-primary/50 transition-colors",
                children: [
                  (0, s.jsxs)("div", {
              ...
              (0, s.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, s.jsx)("p", {
                    className: "text-3xl font-bold text-white",
                    children: o?.enrolledCourses?.length || 0,
                  }),
                  (0, s.jsx)("p", {
                    className: "text-xs text-gray-400 mt-1",
              ...
              (0, s.jsxs)("div", {
                ...
                children: [
                  (0, s.jsx)("h2", {
                    ...
                    children: "Learning Progress This Month",
                  }),
                  (0, s.jsx)("div", {
                    className: "h-64",
                    children: (0, s.jsx)(ay, {
                  ...
                  (0, s.jsxs)("div", {
                    ...
                    children: [
                      (0, s.jsxs)(aw.default, {
                        ...
                        className:
                          "flex items-center gap-3 p-3 rounded-lg hover:bg-white/5 transition-colors border border-transparent hover:border-lumina-primary/20",
                        children: [
                          (0, s.jsx)(aC, {
                            className: "w-6 h-6 text-lumina-primary",
                          }),
                          (0, s.jsxs)("div", {
                            children: [
                              (0, s.jsx)("p", {
          ...
          (0, s.jsxs)("div", {
            children: [
              ...
              (0, s.jsx)("div", {
                ...
                children:
                  o?.enrolledCourses?.length > 0
                    ? o.enrolledCourses.slice(0, 3).map((t) =>
                        (0, s.jsxs)(
                          "div",
                          {
                            className:
                              "glass-card overflow-hidden hover:shadow-gold-glow transition-shadow",
                            children: [
                              (0, s.jsx)("div", {
                                className: "h-40 bg-white/5 relative",
                                children: (0, s.jsx)("div", {
                                  className:
                                    "absolute inset-0 flex items-center justify-center text-gray-500",
                                  children: (0, s.jsx)(ak.BookOpen, {
                                    className: "w-12 h-12",
                                  }),
                                }),
                              }),
                              (0, s.jsxs)("div", {
                                ...
                                children: [
                                  (0, s.jsx)("h3", {
                                    className:
                                      "font-bold text-lg mb-2 text-white",
                                    children: t.name,
                                  }),
                                  (0, s.jsx)("p", {
                                    className:
                                    ...
                                    children: [
                                      (0, s.jsxs)("div", {
                                        ...
                                        children: [
                                          ...
                                          (0, s.jsxs)("span", {
                                            className: "text-lumina-primary",
                                            children: [t.progress || 0, "%"],
                                          }),
                                        ],
                                      }),
                                      (0, s.jsx)("div", {
                                        ...
                                        children: (0, s.jsx)("div", {
                                          className:
                                            "bg-gradient-to-r from-amber-400 to-amber-600 h-2 rounded-full",
                                          style: {
                                            width: `${t.progress || 0}%`,
                                          },
                                        }),
                                  ...
                                  (0, s.jsxs)("div", {
                                    className:
                                      "flex items-center justify-between mb-3 text-sm text-gray-400",
                                    children: [
                                      (0, s.jsxs)("div", {
                    ...
                    : (0, s.jsxs)("div", {
                        className:
                          "col-span-3 text-center py-8 bg-white dark:bg-gray-900 rounded-xl border border-dashed border-gray-300 dark:border-gray-700",
                        children: [
                          (0, s.jsx)("p", {
                          ...
                          (0, s.jsx)(aw.default, {
                            href: "/student/course_explorer",
                            className:
                              "px-4 py-2 bg-amber-500 text-white font-bold rounded-lg hover:bg-amber-600 transition-colors",
              ...
              (0, s.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, s.jsx)("div", {
                    ...
                    children: (0, s.jsx)(aw.default, {
                      href: "/student/progress",
                      className:
                        "text-sm font-medium text-amber-500 hover:text-amber-600",
                    ...
                    children: [
                      (0, s.jsxs)("div", {
                        ...
                        children: [
                          (0, s.jsx)("div", {
                            className:
                              "w-12 h-12 mx-auto mb-2 bg-white/10 rounded-full flex items-center justify-center text-lumina-primary shadow-sm",
                            children: (0, s.jsx)(aE, { className: "w-6 h-6" }),
                          }),
                          (0, s.jsx)("p", {
                      ...
                      (0, s.jsxs)("div", {
                        ...
                        children: [
                          (0, s.jsx)("div", {
                            className:
                              "w-12 h-12 mx-auto mb-2 bg-white/10 rounded-full flex items-center justify-center text-amber-500 shadow-sm",
                            children: (0, s.jsx)(aM.Flame, {
                              className: "w-6 h-6",
                            }),
                          }),
                          (0, s.jsx)("p", {
                      ...
                      (0, s.jsxs)("div", {
                        className:
                          "text-center p-4 rounded-lg bg-white/5 opacity-50",
                        children: [
                          (0, s.jsx)("div", {
                            className:
                              "w-12 h-12 mx-auto mb-2 bg-white/10 rounded-full flex items-center justify-center text-gray-400 shadow-sm",
                            children: (0, s.jsx)(aL.Trophy, {
                              className: "w-6 h-6",
                            }),
                          }),
                          (0, s.jsx)("p", {
                            className: "text-xs font-semibold text-white",
                            children: "Course Master",
                          }),
                        ],
                      }),
                      (0, s.jsxs)("div", {
                        ...
                        children: [
                          (0, s.jsx)("div", {
                            className:
                              "w-12 h-12 mx-auto mb-2 bg-white/10 rounded-full flex items-center justify-center text-gray-400 shadow-sm",
                            children: (0, s.jsx)(aT, { className: "w-6 h-6" }),
                          }),
                          (0, s.jsx)("p", {
                            className: "text-xs font-semibold text-white",
                            children: "Quiz Whiz",
    ...
    sy.register(
      class extends i6 {
        static id = "category";
        static defaults = { ticks: { callback: s2 } };
        constructor(t) {
          super(t),
            (this._startValue = void 0),
            (this._valueRange = 0),
                ...
                : (function (t, e, i, s) {
                    ...
                    if (-1 === a) {
                      ...
                      return (
                        ...
                        "string" == typeof e
                          ? ((r = t.push(e) - 1),
                            s.unshift({ index: r, label: e }))
                          : isNaN(e) && (r = null),
                        r
                      );
                    }
                    return a !== t.lastIndexOf(e) ? i : a;
                  })(a, t, V(e, t), this._addedLabels)),
            (s = a.length - 1),
            null === i ? null : tk(Math.round(i), 0, s)
          );
        }
        determineDataLimits() {
          let { minDefined: t, maxDefined: e } = this.getUserBounds(),
      ...
      sL,
      {
        ...
        start(t, e, i) {
          let s;
          (s = new s$({ ctx: t.ctx, options: i, chart: t })),
            ij.configure(t, s, i),
            ij.addBox(t, s),
            (t.titleBlock = s);
        },
        stop(t) {
          let e = t.titleBlock;
          ij.removeBox(t, e), delete t.titleBlock;
        },
        beforeUpdate(t, e, i) {
          let s = t.titleBlock;
          ij.configure(t, s, i), (s.options = i);
        },
        defaults: {
          align: "center",
          display: !1,
      ...
      },
      {
        ...
        positioners: sU,
        afterInit(t, e, i) {
          i && (t.tooltip = new s1({ chart: t, options: i }));
        },
        beforeUpdate(t, e, i) {
      ...
      },
      {
        ...
        _element: sW,
        start(t, e, i) {
          let s = (t.legend = new sW({ ctx: t.ctx, options: i, chart: t }));
          ij.configure(t, s, i), ij.addBox(t, s);
        },
        stop(t) {
          ij.removeBox(t, t.legend), delete t.legend;
        },
        beforeUpdate(t, e, i) {
          let s = t.legend;
          ij.configure(t, s, i), (s.options = i);
      ...
      class extends iQ {
        ...
        inRange(t, e, i) {
          let { angle: s, distance: a } = t_(this.getProps(["x", "y"], i), {
              x: t,
              y: e,
            }),
            {
        ...
        draw(t) {
          ...
          if (
            ...
            (this.fullCircles = i > ta ? Math.floor(i / ta) : 0),
          ...
          let o = s * (1 - Math.sin(Math.min(ts, i || 0)));
          (t.fillStyle = e.backgroundColor),
            ...
            (function (t, e, i, s, a) {
              ...
              f &&
                ...
                l.selfJoin &&
                  ...
                  (function (t, e, i) {
                    ...
                    if (
                      ...
                      let e = Math.min(h / 2, n * tw(s - i));
                      if ("round" === d)
                        t.arc(a, r, e, i - ts / 2, s + ts / 2, !0);
                      else if ("bevel" === d) {
                        let n = 2 * e * e,
                          o = -n * Math.cos(i + ts / 2) + a,
                          l = -n * Math.sin(i + ts / 2) + r,
                          h = n * Math.cos(s + ts / 2) + a,
                          d = n * Math.sin(s + ts / 2) + r;
                ...
                r || (sM(t, e, i, s, p, a), t.stroke());
            })(t, this, o, a, r),
            t.restore();
        }
      },
    ),
      t.s(["default", () => aj], 27644);
  },
]);
