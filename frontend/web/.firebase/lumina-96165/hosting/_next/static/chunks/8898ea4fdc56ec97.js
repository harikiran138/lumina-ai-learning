  ...
  (e, t, n) => {
    ...
    function L(e, t) {
      ...
      return (
        r ||
          ((r = e._closed
            ? new w("rejected", null, e._closedReason)
            : new w("pending", null, null)),
          n.set(t, r)),
        r
      );
    }
    function F(e, t, n) {
      for (
        ...
        for (; "object" == typeof n && null !== n && n.$$typeof === y; )
          if ((n = n._payload) === r.chunk) n = r.value;
          else {
            switch (n.status) {
              case "resolved_model":
                D(n);
            ...
            switch (n.status) {
              ...
              case "pending":
                i.splice(0, l - 1),
                  null === n.value ? (n.value = [t]) : n.value.push(t),
                  null === n.reason ? (n.reason = [t]) : n.reason.push(t);
                return;
              case "halted":
                return;
              default:
                U(e, t.handler, n.reason);
                return;
            }
          }
        n = n[i[l]];
      ...
      for (; "object" == typeof n && null !== n && n.$$typeof === y; )
        if ((t = n._payload) === r.chunk) n = r.value;
        else {
          switch (t.status) {
            case "resolved_model":
              D(t);
    ...
    function Q(e, t, n) {
      ...
      r && "pending" !== r.status
        ...
        : ((n = new w("fulfilled", n, null)), e.set(t, n));
    }
    function Z(e, t, n, r) {
      var o = e._chunks,
        u = o.get(t);
      ...
      (a[h] = function () {
        ...
        return (
          ((e = {
            next: (e = function (e) {
              ...
              if (t === r.length) {
                if (o)
                  return new w("fulfilled", { done: !0, value: void 0 }, null);
        ...
        Z(e, t, n ? a[h]() : a, {
          enqueueValue: function (t) {
            if (u === r.length)
              r[u] = new w("fulfilled", { done: !1, value: t }, null);
            else {
              var n = r[u],
                o = n.value,
                a = n.reason;
          ...
          close: function (t) {
            for (
              o = !0,
                u === r.length ? (r[u] = j(e, t, !0)) : $(e, r[u], t, !0),
                u++;
              u < r.length;
          ...
          error: function (t) {
            for (
              o = !0, u === r.length && (r[u] = new w("pending", null, null));
              u < r.length;
        ...
        .then(function t(i) {
          ...
          for (
            ...
            if (-1 < g)
                ...
                switch (((u = i += t.decode(a)), r)) {
                  case 73:
                    ...
                    if ((p = c(h))) {
                      if (v) {
                        var g = v;
                        g.status = "blocked";
                      } else (g = new w("blocked", null, null)), y.set(f, g);
                      p.then(
                        function () {
                          return P(s, g, h);
                        },
                      ...
                      v
                        ? P(s, v, h)
                        : ((v = new w("resolved_module", h, null)),
                          y.set(f, v));
                    break;
                  case 72:
                    switch (
                  ...
                  case 69:
                    (a = (r = e._chunks).get(n)),
                      ...
                      a
                        ? A(e, a, t)
                        : ((e = new w("rejected", null, t)), r.set(n, e));
                    break;
                  case 84:
              ...
              })(e, u, i, p, v, (y = new Uint8Array(l.buffer, b, g - s))),
                (s = g),
                3 === f && s++,
                (y = i = p = f = 0),
                (v.length = 0);
