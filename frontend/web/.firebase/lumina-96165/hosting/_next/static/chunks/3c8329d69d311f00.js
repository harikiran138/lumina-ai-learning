(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
    ...
    class p extends i.default.Component {
      ...
      render() {
        return this.state.error && !s
          ? (0, a.jsxs)(a.Fragment, {
              children: [
                (0, a.jsx)(d.HandleISRError, { error: this.state.error }),
                ...
                let [o, a, i, l, c, d] = t,
                  f =
                    ...
                    r.startsWith(u.PAGE_SEGMENT_KEY + "?")
                      ...
                      : r,
                  s = {};
                for (let [t, r] of Object.entries(a)) s[t] = e(r);
                let p = [f, s, null, (n = l) && "refresh" !== n ? l : null];
                return (
                  void 0 !== c && (p[4] = c), void 0 !== d && (p[5] = d), p
                );
              })(e),
            ),
          );
  ...
  (e, t, r) => {
    ...
    async function y(e, t) {
      ...
      try {
        ...
        let y = await g;
        if ((0, s.getAppBuildId)() !== y.b) return b(r.url);
        let m = (0, f.normalizeFlightData)(y.f);
        if ("string" == typeof m) return b(m);
        return {
          flightData: m,
          canonicalUrl: a,
  ...
  (e, t, r) => {
    ...
    function p({ children: e }) {
      let t = (0, l.useRouter)();
      return (0, a.jsx)(s, { router: t, children: e });
    }
    ("function" == typeof r.default ||
      ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
