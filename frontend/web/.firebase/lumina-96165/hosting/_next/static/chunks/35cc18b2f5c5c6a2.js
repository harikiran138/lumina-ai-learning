(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    let r = (e = new Map(), r = null, o) => ({
      ...
      a = (e, o) => {
        let t = r();
        for (let r in e) l(e[r], t, r, o);
        return t;
      },
      l = (e, r, o, t) => {
        let a = e.length;
        for (let l = 0; l < a; l++) n(e[l], r, o, t);
      },
      n = (e, r, o, t) => {
        "string" == typeof e
          ? s(e, r, o)
      ...
      en = ((e, ...r) => {
                      ...
                      if (e.startsWith("[") && e.endsWith("]")) {
                        ...
                        return -1 === (o = e).slice(1, -1).indexOf(":")
                          ...
                          : ((t = (r = o.slice(1, -1)).indexOf(":")),
                            (a = r.slice(0, t)) ? "arbitrary.." + a : void 0);
                      }
                      let a = e.split("-"),
                        l = +("" === a[0] && a.length > 1);
                      return t(a, l, r);
        ...
        let e = h("color"),
          ...
          el = () => ["auto", "cover", "contain", L, q, { size: [D, B] }],
          en = () => [I, F, K],
          es = () => ["", "none", "full", d, D, B],
          ei = () => ["", O, F, K],
    ...
    function ei(e) {
      return {
        ...
        warning: "#f59e0b",
        error: "#ef4444",
        text: e ? "#d1d5db" : "#4b5563",
        grid: e ? "rgba(255, 255, 255, 0.1)" : "rgba(0, 0, 0, 0.1)",
        background: "rgba(251, 191, 36, 0.2)",
      };
    }
    e.s(["cn", () => es, "getChartColors", () => ei], 75157);
  },
]);
