  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-black text-white transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="absolute top-4 left-4 z-20">
        <Link
          href="/"
          className="p-2 rounded-lg flex items-center text-gray-400 hover:text-white transition-colors hover:bg-white/10"
        >
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a
                  href="#"
                  className="font-medium text-lumina-primary hover:text-yellow-400 text-xs"
                >
                  Forgot password?
                </a>
              </div>
