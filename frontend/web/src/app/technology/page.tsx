    ...
    <div className="text-white min-h-screen bg-slate-950 selection:bg-lumina-highlight/30 selection:text-white">
      ...
      <main className="pt-32">
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="glass-v2 rounded-[48px] border border-white/10 p-12 lg:p-24 relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10">
              <div className="space-y-8">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-lumina-highlight/10 border border-lumina-highlight/20 text-lumina-highlight text-[10px] font-bold uppercase tracking-widest">
                  <Sparkles className="w-3 h-3" />
                  Machine Learning Engine
                </div>
                <h2 className="text-4xl md:text-5xl font-display font-bold text-white leading-tight">Mastery Modeling <br /> redefined.</h2>
                ...
                <div className="pt-4 grid grid-cols-2 gap-8">
                  <div>
                    <h3 className="text-3xl font-display font-bold text-white mb-1">98.4%</h3>
                    <p className="text-xs text-gray-500 uppercase tracking-widest">Prediction Accuracy</p>
                  </div>
                  <div>
                    <h3 className="text-3xl font-display font-bold text-white mb-1">&lt;200ms</h3>
                    <p className="text-xs text-gray-500 uppercase tracking-widest">Inference Latency</p>
                  </div>
                </div>
              </div>
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl border border-white/5 bg-white/[0.01]">
              <h4 className="font-bold text-white mb-2">FERPA / SOC2</h4>
              <p className="text-sm text-gray-500">Every byte of student data is encrypted in transit and at rest with institutional keys.</p>
            </div>
            <div className="p-8 rounded-3xl border border-white/5 bg-white/[0.01]">
              <h4 className="font-bold text-white mb-2">Human-in-the-loop</h4>
              <p className="text-sm text-gray-500">Teachers have final override on AI-generated grades and feedback suggestions.</p>
            </div>
            <div className="p-8 rounded-3xl border border-white/5 bg-white/[0.01]">
              <h4 className="font-bold text-white mb-2">Explainable AI</h4>
              <p className="text-sm text-gray-500">We provide the evidence link for every AI intervention, explaining exactly why a student was flagged.</p>
            </div>
          </div>
        </section>
      </main>
...
function TechCard({ icon: Icon, title, detail }: { icon: any, title: string, detail: string }) {
  return (
    <div className="p-8 rounded-[32px] border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] transition-all group">
      <div className="h-12 w-12 rounded-xl bg-white/5 flex items-center justify-center text-gray-400 group-hover:text-lumina-highlight transition-colors mb-6">
