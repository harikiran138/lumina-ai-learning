      ...
      {loading ? (
        ...
        <div className="grid gap-6">
          ...
          {assignments.map((asm) => (
            <div
              key={asm.id}
              className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow border border-gray-200 dark:border-gray-700 flex flex-col md:flex-row gap-6"
            >
              ...
              <div className="flex-1 space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mb-2">
                    {new Date(asm.timestamp).toLocaleString()}
                  </p>
