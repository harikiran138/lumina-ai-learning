    ...
    <div className="space-y-8">
      ...
      <div className="relative z-10">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Here's your personalized learning snapshot.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="glass-card p-5 hover:border-lumina-primary/50 transition-colors group">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-semibold text-gray-400 group-hover:text-purple-500 transition-colors">
              MASTERY
            </span>
        ...
        <div className="glass-card p-6">
          ...
          <div className="space-y-3">
            <Link
              ...
              className="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-all border border-transparent hover:border-lumina-primary/30 group"
            >
              ...
              <div>
                <p className="font-semibold text-sm text-white group-hover:text-lumina-primary transition-colors">
                  Ask AI Tutor
                </p>
            ...
            <Link
              ...
              className="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-all border border-transparent hover:border-purple-500/30 group"
            >
            ...
            <Link
              ...
              className="flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-all border border-transparent hover:border-green-500/30 group"
            >
              ...
              <div>
                <p className="font-semibold text-sm text-white group-hover:text-green-400 transition-colors">
                  View Notes
                </p>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link
            ...
            className="text-sm font-bold text-lumina-primary hover:text-amber-400 px-4 py-2 bg-lumina-primary/10 rounded-lg transition-colors"
          >
            View All →
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {dashboardData?.enrolledCourses?.length > 0 ? (
            dashboardData.enrolledCourses.slice(0, 3).map((course: any) => (
              <div
                key={course.id}
                className="glass-card overflow-hidden hover:shadow-gold-glow transition-all group"
              >
                <div className="h-40 bg-white/5 relative overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3 bg-black/40 backdrop-blur-md px-2 py-1 rounded-md border border-white/10">
                    <span className="text-xs font-bold text-lumina-primary">
                      {course.subject || "Course"}
                    </span>
                  </div>
                </div>
                <div className="p-5">
                  <h3 className="font-bold text-lg mb-2 text-white line-clamp-1 group-hover:text-lumina-primary transition-colors">
                    {course.name}
                  </h3>
                  ...
                  <Link
                    ...
                    className="w-full py-2.5 rounded-xl bg-white/5 hover:bg-lumina-primary text-gray-300 hover:text-black font-semibold text-sm transition-all flex items-center justify-center gap-2 group-hover:shadow-lg group-hover:shadow-lumina-primary/20"
                  >
                    Continue Learning
                  </Link>
                </div>
            ...
            <div className="col-span-3 text-center py-12 bg-white/5 rounded-2xl border border-dashed border-white/10">
              ...
              <Link
                ...
                className="px-6 py-2 bg-lumina-primary text-black font-bold rounded-xl hover:bg-amber-400 transition-colors shadow-lg shadow-lumina-primary/20"
              >
                Explore Courses
              </Link>
            </div>
                ...
                >
                  <div
                    className={`w-12 h-12 mx-auto mb-3 rounded-full flex items-center justify-center shadow-lg ${
                      ach.unlocked
                        ? "bg-gradient-to-br from-lumina-primary to-amber-600 text-black"
