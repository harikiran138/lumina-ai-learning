...
export default function StudentProgress() {
  ...
  if (isLoading)
    return (
      <div className="text-white text-center p-10">Loading progress...</div>
    );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="glass-card p-6">
            ...
            <div className="h-64 bg-white/5 rounded-xl flex items-end justify-between p-4 gap-2">
              {(data?.weeklyActivity || [0, 0, 0, 0, 0, 0, 0]).map(
                (h: number, i: number) => (
                  <div
                    key={i}
        ...
        <div className="glass-card p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-sm text-lumina-primary cursor-pointer hover:underline">
              View All
            </span>
          </div>
            ...
            {data?.achievements?.map((ach: any, i: number) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Icon
                      className={`w-5 h-5 ${ach.color || "text-gray-400"}`}
                    />
                  </div>
                  <div>
