...
export default function StudentProfile() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [profileData, certificatesData, badgesData, masteryData] =
          await Promise.all([
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <div className="glass-card p-6 text-center relative group backdrop-blur-md bg-black/40 border-white/10">
              ...
              <p className="text-sm text-lumina-primary mb-4">
                  ...
                  <button 
                    onClick={() => {
                      if (profile.parent_link_code) {
                        navigator.clipboard.writeText(profile.parent_link_code);
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              {badges.length > 0 ? (
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {badges.map((badge) => {
                    ...
                    const IconComponent =
                      badge.icon === "Sparkles" ? Sparkles : Award;
            ...
            <h3 className="text-lg font-bold text-white mb-6 pl-2 border-l-4 border-lumina-primary">
              Recent Activity
            </h3>
