...
export default function CourseManagementPage() {
  ...
  const [expandingModuleId, setExpandingModuleId] = useState<string | null>(
    null,
  );
  ...
  const handleInvite = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        setInviteMessage({
          type: "error",
          text: res.error || "Failed to add student.",
        });
      }
    } catch (error) {
      console.error(error);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1
            className="text-2xl font-bold text-white flex items-center gap-2 group cursor-pointer"
          ...
          <div className="glass-card p-6">
            ...
            {isAddingModule && (
              <form
                ...
                className="mb-6 bg-white/5 p-4 rounded-xl border border-amber-500/30"
              >
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          onClick={(e) => {
                            ...
                            setExpandingModuleId(module.id);
                          }}
                        >
                          <Plus className="w-4 h-4" />
                        </button>
