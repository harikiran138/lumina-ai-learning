...
class DataManager {
  ...
  setupAutoBackup(intervalHours = 24) {
    ...
    this.ui.showNotification(
      `Auto backup enabled (every ${intervalHours}h)`,
      "success",
      2000,
    );
  }
  ...
  async generateSampleData() {
    try {
      ...
      const sampleUsers = [
        {
          name: "Emma Watson",
          email: "emma.watson@student.lumina.edu",
          role: "student",
        },
        {
          name: "John Smith",
          email: "john.smith@student.lumina.edu",
          role: "student",
        },
        {
          name: "Sarah Johnson",
          email: "sarah.johnson@student.lumina.edu",
          role: "student",
        },
        {
          name: "Dr. Michael Brown",
          email: "michael.brown@lumina.edu",
          role: "teacher",
        },
        {
          name: "Lisa Chen",
          email: "lisa.chen@student.lumina.edu",
          role: "student",
        },
      ];
  ...
  createDataManagementModal() {
    ...
    modal.className =
      "fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center p-4 hidden";
