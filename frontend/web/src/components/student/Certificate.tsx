        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center p-16 text-center">
            ...
            <div className="mb-8 flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500 uppercase tracking-[0.3em] mt-2">
            ...
            <div className="space-y-6 max-w-3xl">
              ...
              <p className="text-gray-500 mt-4 leading-relaxed max-w-2xl mx-auto">
                Demonstrating dedication to learning and mastery of the
                fundamental concepts and practical applications taught within
                this curriculum.
              </p>
            </div>
