      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white mb-6 font-display">
             The Problem with <span className="text-lumina-accent">Traditional Education</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {problems.map((problem, index) => (
            <div key={index} className="glass-v2 p-8 group border-white/5 hover:border-lumina-accent/20">
              <div className="w-14 h-14 rounded-2xl bg-lumina-accent/10 flex items-center justify-center mb-6 group-hover:bg-lumina-accent/20 transition-all duration-500">
                <problem.icon className="h-7 w-7 text-lumina-accent" />
              </div>
