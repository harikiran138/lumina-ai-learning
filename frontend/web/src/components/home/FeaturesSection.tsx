      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-gray-300">
            An all-in-one, ethical, and private education ecosystem.
          </p>
        </div>
        <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex flex-col items-center text-center p-6 rounded-2xl transition-all bg-white/10 dark:bg-white/5 backdrop-blur-lg border border-white/20 shadow-xl">
            ...
            <h3 className="mt-5 text-xl font-semibold gradient-text">
              Adaptive Pathways
            </h3>
            <p className="mt-2 text-gray-300">
              AI generates personalized learning roadmaps based on student
          ...
          <div className="flex flex-col items-center text-center p-6 rounded-2xl transition-all bg-white/10 dark:bg-white/5 backdrop-blur-lg border border-white/20 shadow-xl">
            ...
            <p className="mt-2 text-gray-300">
              Save time with AI-generated questions, auto-grading, and
              insightful feedback.
            </p>
          </div>
          <div className="flex flex-col items-center text-center p-6 rounded-2xl transition-all bg-white/10 dark:bg-white/5 backdrop-blur-lg border border-white/20 shadow-xl">
            ...
            <p className="mt-2 text-gray-300">
              Run Lumina on your own servers. No external APIs, full data
              sovereignty, and complete privacy.
            </p>
          </div>
        </div>
      </div>
