        ...
        <div className="mt-12 grid gap-8 md:grid-cols-3">
          <div className="bg-white/10 dark:bg-white/5 backdrop-blur-lg p-8 rounded-2xl shadow-xl border border-white/20">
            ...
            <p className="mt-4 text-gray-300">
              Experience learning that adapts to your pace. Get instant
              feedback, track your progress with engaging streaks, and never
          ...
          <div className="bg-white/10 dark:bg-white/5 backdrop-blur-lg p-8 rounded-2xl shadow-xl border border-white/20">
            ...
            <p className="mt-4 text-gray-300">
              Automate the tedious work. Convert your existing materials into
              interactive courses, generate assessments instantly, and get deep
          ...
          <div className="bg-white/10 dark:bg-white/5 backdrop-blur-lg p-8 rounded-2xl shadow-xl border border-white/20">
            ...
            <p className="mt-4 text-gray-300">
              Own your educational ecosystem. Lumina is a scalable, secure, and
              private solution that integrates with your existing LMS and
