    ...
    <section className="py-20 bg-slate-950/50 border-y border-white/5">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="inline-block px-3 py-1 rounded-md bg-white/5 border border-white/10 text-[10px] font-bold uppercase tracking-widest text-slate-500">
            Role Significance
          </div>
          ...
          <p className="text-xl text-slate-300 leading-relaxed font-sans max-w-2xl">
            {content}
          </p>
        </div>
      </div>
