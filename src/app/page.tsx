    ...
    return (
        <div className="bg-black text-white min-h-screen">
            ...
            <main>
                ...
                {/* Features Section */}
                <section id="features" className="min-h-screen flex items-center bg-white dark:bg-gray-900">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                        ...
                        <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                            <div className="flex flex-col items-center text-center p-6 border border-transparent hover:border-amber-500/20 hover:bg-amber-500/5 dark:hover:bg-amber-500/5 rounded-2xl transition-all">
                                <div className="bg-amber-100 dark:bg-amber-500/10 text-amber-600 dark:text-amber-400 p-4 rounded-full">
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                        ...
                        <div className="mt-12 grid gap-8 md:grid-cols-3">
                            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800">
                                ...
                                <p className="mt-4 text-gray-600 dark:text-gray-400">Experience learning that adapts to your pace. Get instant feedback, track your progress with engaging streaks, and never feel overwhelmed again.</p>
                            </div>
                            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800">
                                <h3 className="text-xl font-bold gradient-text">For Teachers</h3>
                                <p className="mt-4 text-gray-600 dark:text-gray-400">Automate the tedious work. Convert your existing materials into interactive courses, generate assessments instantly, and get deep insights into class performance.</p>
                            </div>
                            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800">
                                <h3 className="text-xl font-bold gradient-text">For Institutions</h3>
                                <p className="mt-4 text-gray-600 dark:text-gray-400">Own your educational ecosystem. Lumina is a scalable, secure, and private solution that integrates with your existing LMS and respects data sovereignty.</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="how-it-works" className="min-h-screen flex items-center bg-white dark:bg-gray-900">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                        <div className="text-center">
                        ...
                        <div className="mt-12 relative">
                            ...
                            <div className="grid gap-12 md:grid-cols-3 relative">
                                <div className="flex flex-col items-center text-center">
                                    <div className="bg-white dark:bg-gray-900 border-2 border-gray-300 dark:border-gray-700 h-16 w-16 rounded-full flex items-center justify-center text-amber-500 font-bold text-2xl relative z-10">1</div>
                                ...
                                <div className="flex flex-col items-center text-center">
                                    <div className="bg-white dark:bg-gray-900 border-2 border-gray-300 dark:border-gray-700 h-16 w-16 rounded-full flex items-center justify-center text-amber-500 font-bold text-2xl relative z-10">2</div>
                                ...
                                <div className="flex flex-col items-center text-center">
                                    <div className="bg-white dark:bg-gray-900 border-2 border-gray-300 dark:border-gray-700 h-16 w-16 rounded-full flex items-center justify-center text-amber-500 font-bold text-2xl relative z-10">3</div>
                ...
                <section id="testimonials" className="min-h-screen flex items-center">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                        ...
                        <div className="mt-12 grid gap-8 md:grid-cols-2">
                            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800">
                                <p className="text-gray-700 dark:text-gray-300">"Lumina has been a game-changer for my classroom. I can finally spend more time teaching and less time creating materials. The students are more engaged than ever before!"</p>
                            ...
                            <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-800">
                                <p className="text-gray-700 dark:text-gray-300">"The personalized pathway helped me focus on my weak spots in chemistry. The streak feature is surprisingly motivating, and I actually enjoy studying now."</p>
                                <div className="flex items-center mt-6">
