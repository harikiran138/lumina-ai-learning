...
export default function AdminDashboard() {
    const [activeTab, setActiveTab] = useState<'overview' | 'users' | 'courses' | 'ai-logs' | 'community'>('overview');
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            className={`p-1.5 hover:bg-white/10 rounded ${user.status === 'active' ? 'text-red-400' : 'text-green-400'}`}
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex gap-4 border-b border-white/10 pb-4 overflow-x-auto">
                {['overview', 'users', 'courses', 'ai-logs', 'community'].map((tab) => (
                    <button
                        key={tab}
