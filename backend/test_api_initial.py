...
class Tester:
    ...
    def submit_assignment(self):
        ...
        with open("test_submission.txt", "rb") as f:
            ...
            res = requests.post(f"{API_URL}/assignments/submit", data=data, files=files, headers=headers)
    ...
    def upload_note(self):
        ...
        with open("test_note.txt", "w") as f:
            f.write("Newton's laws of motion are three laws that describe the relationship between the motion of an object and the forces acting on it.")
