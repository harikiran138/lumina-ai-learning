...
from app.assessment.models.schemas import AssessmentSession, StudentResponse, Question, AssessmentResult, MasteryState
...
class SessionManager:
    ...
    def create_session(self, student_id: str, topic: str, initial_difficulty: float = 0.5, num_questions: int = 5) -> AssessmentSession:
    ...
    def submit_answer(self, session_id: str, question_id: str, selected_option_id: str, is_correct: bool = None, time_taken: float = None) -> AssessmentSession:
        ...
        if question:
            ...
            if is_correct is not None:
                calculated_is_correct = is_correct
                 ...
                 logger.warning(f"Question {question_id} not found in session history for validation.")
