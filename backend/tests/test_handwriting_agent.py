...
def test_orchestrator_routing():
    ...
    orchestrator.handwriting_agent.analyze = MagicMock(
        return_value={"extracted_text": "mock", "score": 1.0}
    )

    context = {"type": "handwriting_analysis", "file_path": "dummy.jpg", "answer_key": "dummy key"}
